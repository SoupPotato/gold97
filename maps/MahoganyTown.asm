...
MahoganyTown_MapEvents:
	...
	db 4 ; bg events
	bg_event  6, 12, BGEVENT_READ, MahoganyTownSign
	bg_event 16,  4, BGEVENT_READ, MahoganyTownRagecandybarSign
	bg_event 14, 12, BGEVENT_READ, MahoganyGymSign
	bg_event  4, 12, BGEVENT_READ, MahoganyTownPokecenterSign
