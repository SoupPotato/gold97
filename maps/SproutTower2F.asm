...
SproutTower2F_MapEvents:
	...
	db 5 ; object events
	object_event  2,  3, SPRITE_SABRINA, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 2, TrainerMediumMartha, EVENT_OLD_CITY_EARL
	object_event  2,  6, SPRITE_SABRINA, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 2, TrainerMediumGrace, EVENT_OLD_CITY_EARL
	object_event  5,  3, SPRITE_SABRINA, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 2, TrainerMediumBethany, EVENT_OLD_CITY_EARL
	object_event  5,  6, SPRITE_SABRINA, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 2, TrainerMediumMargret, EVENT_OLD_CITY_EARL
