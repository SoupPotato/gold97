...
Route34_MapEvents:
	...
	db 4 ; bg events
	bg_event 13,  5, BGEVENT_READ, Route34Sign
	bg_event  9, 31, BGEVENT_READ, Route34TrainerTips
	bg_event  3, 39, BGEVENT_ITEM, Route34HiddenRareCandy
...
;	object_event 14, 46, SPRITE_COOLTRAINER_F, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_TRAINER, 2, TrainerCooltrainerfKate, -1
	object_event 19, 18, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route34Nugget, EVENT_ROUTE_34_NUGGET
	object_event 17, 44, SPRITE_OFFICER, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 1, SoldierGeraldScript, -1
