...
DarkCaveVioletEntrance_MapEvents:
	...
	object_event  8, 30, SPRITE_GROWLITHE, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, RaikouEvent, EVENT_AZALEA_TOWN_SLOWPOKES
