...
TeamRocketBaseB2FComputerConsole:
;	setevent EVENT_ROUTE_30_BATTLE
	...
	pause 50
	writetext TeamRocketBaseB2FComputerConsoleIntroText
	waitbutton
	jump TeamRocketBaseB2FComputerConsole_loop
...
TeamRocketBaseB2FComputerConsole_loop:
	writetext ConsoleWhatDo
	loadmenu TeamRocketBaseB2FComputerConsoleMenu
	verticalmenu
	closewindow
	ifequal 1, .consolemenu1
	ifequal 2, .consolemenu2
	ifequal 3, .consolemenu3
	jump TeamRocketBaseB2FComputerConsole_cancel
...
TeamRocketBaseB2FComputerPower_loop:
	writetext ConsoleWhatDoPower
	loadmenu TeamRocketBaseB2FComputerConsolePowerMenu
	verticalmenu
	closewindow
...
TeamRocketBaseB2FComputerConsoleMenu:
...
TeamRocketBaseB2FComputerConsolePowerMenu:
	db MENU_BACKUP_TILES ; flags
	menu_coords 0, 2, 19, TEXTBOX_Y - 1
...
TeamRocketBaseB2FComputerConsole_cancel:
	writetext TeamRocketBaseB2FComputerConsoleCancelText
	waitbutton
	playsound SFX_SHUT_DOWN_PC
	closetext
	end
...
TeamRocketBaseB2F_MapEvents:
	...
	db 5 ; bg events
	bg_event 25, 16, BGEVENT_ITEM, TeamRocketBaseB2FHiddenFullHeal
	bg_event 12, 19, BGEVENT_READ, TeamRocketBaseB2FComputerConsole
	bg_event 13, 19, BGEVENT_READ, TeamRocketBaseB2FComputerConsole
	bg_event 16, 19, BGEVENT_READ, TeamRocketBaseB2FComputerConsole
	bg_event 17, 19, BGEVENT_READ, TeamRocketBaseB2FComputerConsole
