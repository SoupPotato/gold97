...
ViridianGym_MapScripts:
	db 2 ; scene scripts
	scene_script .SceneViridianGymGreetings ; SCENE_DEFAULT
	scene_script .SceneViridianGymImposter ;
...
.SceneViridianGymGreetings
	end

.SceneViridianGymImposter
	end
