...
RivalBattleFinal:
	...
	pause 15
	turnobject UNDERGROUNDPATH_SILVER, DOWN
	pause 15
	applymovement UNDERGROUNDPATH_SILVER, UndergroundSilverWalksToPlayer
...
.returnfrombattle
	...
	applymovement UNDERGROUNDPATH_SILVER, UndergroundSilverLeavesMovement
	disappear UNDERGROUNDPATH_SILVER
...
UndergroundPath_MapEvents:
	...
	db 2 ; bg events
	bg_event  5, 16, BGEVENT_ITEM, UndergroundPathHiddenFullRestore
	bg_event 12, 14, BGEVENT_ITEM, UndergroundPathHiddenXSpecial
