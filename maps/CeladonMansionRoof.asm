...
CeladonMansionRoof_MapEvents:
	...
	db 3 ; warp events
	warp_event  2,  1, CELADON_MANSION_3F, 1
	...
	db 1 ; bg events
	bg_event  0,  6, BGEVENT_LEFT, CeladonMansionRoofGraffiti

	db 1 ; object events
	object_event  1,  3, SPRITE_FISHER, SPRITEMOVEDATA_WALK_UP_DOWN, 0, 1, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, CeladonMansionRoofFisherScript, -1
