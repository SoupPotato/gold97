...
TeamRocketBaseB1F_MapEvents:
	...
	object_event 21, 24, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_LEFT, 1, 1, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_TRAINER, 2, TrainerGruntM16, EVENT_STAND_CITY_ROCKETS_DEPARTED
