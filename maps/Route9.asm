...
Route9_MapEvents:
	...
	db 2 ; bg events
	bg_event  3,  9, BGEVENT_READ, Route9Sign
	...
	object_event  5,  9, SPRITE_YOUNGSTER, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_TRAINER, 4, TrainerCamperSid, -1
