...
Route10North_MapEvents:
	...
	object_event 50,  5, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route10NorthCleanseTag, EVENT_PICKED_UP_STAR_PIECE_FROM_OMANYTE_ITEM_ROOM
