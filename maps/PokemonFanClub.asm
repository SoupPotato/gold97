...
PokemonFanClubBudleefScript:
	opentext
	writetext FanClubBudleefText
	cry BUDLEEF
	waitbutton
	closetext
	end
...
PokemonFanClub_MapEvents:
	...
	object_event  7,  3, SPRITE_ODDISH, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, PokemonFanClubBudleefScript, -1
