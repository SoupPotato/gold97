...
DanceTheatreScientist1Script:
	jumptextfaceplayer DanceTheatreScientist1Text
	
DanceTheatreGentlemanScript:
	jumptextfaceplayer DanceTheatreGentlemanText
	
DanceTheatreBookshelf:
...
DanceTheatre_MapEvents:
	...
	db 8 ; bg events
	bg_event 15,  1, BGEVENT_READ, DanceTheatreBookshelf
	bg_event 14,  1, BGEVENT_READ, DanceTheatreBookshelf
	bg_event 13,  1, BGEVENT_READ, DanceTheatreBookshelf
	bg_event 12,  1, BGEVENT_READ, DanceTheatreBookshelf
	bg_event  7, 13, BGEVENT_READ, DanceTheatreBookshelf
	bg_event  6, 13, BGEVENT_READ, DanceTheatreBookshelf
	bg_event  5, 13, BGEVENT_READ, DanceTheatreBookshelf
	bg_event  4, 13, BGEVENT_READ, DanceTheatreBookshelf

	db 3 ; object events
	object_event  2,  3, SPRITE_SCIENTIST, SPRITEMOVEDATA_STANDING_DOWN, 1, 1, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, DanceTheatreFossilScientist, -1
	object_event 13,  2, SPRITE_SCIENTIST, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 1, 1, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, DanceTheatreScientist1Script, -1
	object_event 16, 14, SPRITE_GENTLEMAN, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, DanceTheatreGentlemanScript, -1
