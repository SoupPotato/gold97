...
.SkipTeleportTextWest
	...
	waitsfx
	warp VERMILION_PORT_PASSAGE, 13, 2
	end
...
OlivinePortPassage_MapEvents:
	...
	db 5 ; warp events
	warp_event 19,  4, GOLDENROD_CITY, 14
	warp_event 19,  5, GOLDENROD_CITY, 15
	...
	db 3 ; object events
	object_event 18,  2, SPRITE_POKEFAN_M, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, OlivinePortPassagePokefanMScript, EVENT_OLIVINE_PORT_PASSAGE_POKEFAN_M
