...
CeladonGymGuyScript2:
	faceplayer
	checkevent EVENT_GOT_SHUCKIE
	iftrue .CeladonGymGuyRedNotHereScript2
	checkevent EVENT_BEAT_ERIKA
	iftrue .CeladonGymGuyWinScript2
	opentext
	writetext CeladonGymGuyText2
	waitbutton
	closetext
	end
	
.CeladonGymGuyRedNotHereScript2
	opentext
	writetext CeladonGymGuyRedNotHereText2
	waitbutton
	closetext
	end

.CeladonGymGuyWinScript2:
	opentext
	writetext CeladonGymGuyWinText2
	waitbutton
	closetext
	end
...
CeladonGym_MapEvents:
	...
	db 7 ; object events
	object_event  4,  7, SPRITE_RED, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, CeladonGymErikaScript, EVENT_GOT_SHUCKIE
	...
	object_event -5, -5, SPRITE_RED, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, CeladonGymErikaScript, -1
	object_event  7, 15, SPRITE_GYM_GUY, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, CeladonGymGuyScript2, -1
