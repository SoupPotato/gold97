...
AzaleaGym_MapEvents:
	...
	db 2 ; bg events
	bg_event  3, 15, BGEVENT_READ, AzaleaGymStatue
	bg_event  6, 15, BGEVENT_READ, AzaleaGymStatue
	...
	object_event  7, 15, SPRITE_GYM_GUY, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, AzaleaGymGuyScript, -1
