...
Route32RuinsOfAlphGate_MapEvents:
	...
	db 4 ; warp events
	warp_event  0,  7, RUINS_OF_ALPH_OUTSIDE, 11
	warp_event  1,  7, RUINS_OF_ALPH_OUTSIDE, 11
	warp_event  8,  7, ROUTE_32, 2
	warp_event  9,  7, ROUTE_32, 2
	...
	object_event  1,  3, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, Route32RuinsOfAlphGateYoungsterScript, -1
