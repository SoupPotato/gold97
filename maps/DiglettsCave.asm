...
DiglettsCave_MapEvents:
	...
	db 4 ; warp events
	warp_event  5, 15, ROUTE_3, 1
	warp_event 55, 15, ROUTE_3, 2
	...
	db 1 ; bg events
	bg_event  7, 10, BGEVENT_ITEM, DiglettsCaveHiddenMaxRevive
	...
	object_event  4,  4, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, DiglettsCaveTMDynamicpunch, EVENT_ROUTE_45_REVIVE
