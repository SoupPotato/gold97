	...
	const CIANWOOD_LUGIA_SPEECH_HOUSE_GRANNY
...
CianwoodLugiaSpeechHouseGrannyScript:
	faceplayer
	opentext
	checkevent EVENT_SWITCH_10
	iftrue .alreadygavescopelens
	writetext CianwoodLugiaSpeechHouseGrannyText1
	waitbutton
...
.alreadygavescopelens
	writetext CianwoodLugiaSpeechHouseGrannyText2
	waitbutton
	closetext
	end
...
CianwoodLugiaSpeechHouseGrannyText1:
	text "I was a LEAGUE"
...
CianwoodLugiaSpeechHouseGrannyText2:
...
CianwoodLugiaSpeechHouse_MapEvents:
	...
	db 1 ; object events
	object_event  7,  3, SPRITE_GRANNY, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, CianwoodLugiaSpeechHouseGrannyScript, -1
