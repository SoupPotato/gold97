...
VioletKylesHouse_MapEvents:
	...
	warp_event  5,  7, ECRUTEAK_CITY, 14
	...
	db 2 ; object events
	object_event  1,  2, SPRITE_POKEFAN_F, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 1, 1, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, VioletKylesHousePokefanMScript, -1
