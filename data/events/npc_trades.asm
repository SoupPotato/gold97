...
; entries correspond to NPCTRADE_* constants
	npctrade TRADE_DIALOGSET_COLLECTOR, RINRING,    BOMSEAL,  "TRICKY@@@@@", $37, $66, GOLD_BERRY,   37460, "ANGIE@@@@@@", TRADE_GENDER_EITHER
	npctrade TRADE_DIALOGSET_COLLECTOR, BELLSPROUT, CURSTRAW,     "STITCHES@@@", $96, $66, BITTER_BERRY, 48926, "KYLE@@@@@@@", TRADE_GENDER_EITHER
