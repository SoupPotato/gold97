...
; there are NUM_ROAMMON_MAPS entries
	...
	roam_map ROUTE_37, ROUTE_36, ROUTE_38
	roam_map ROUTE_38, ROUTE_37, ROUTE_39
	roam_map ROUTE_39, ROUTE_38
	roam_map ROUTE_43, ROUTE_44, ROUTE_37, ROUTE_38
	roam_map ROUTE_43, ROUTE_44
	roam_map ROUTE_44, ROUTE_43, ROUTE_45
