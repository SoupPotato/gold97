...
CherrygroveCityName: db "PRINCE CITY@"
OldCityName:      db "OLD CITY@"
AzaleaTownName:      db "BIRDON TOWN@"
GoldenrodCityName:   db "WEST CITY@"
EcruteakCityName:    db "TEKU CITY@"
OlivineCityName:     db "NUTYPE CITY@"
CianwoodCityName:    db "SOUTH POINT@"
MahoganyTownName:    db "HONTO TOWN@"
BlackthornCityName:  db "BLUE FOREST@"
LakeOfRageName:      db "LAKE OF¯RAGE@"
SilverCaveName:      db "SILVER CAVE@"
SproutTowerName:     db "5 FLOOR¯TOWER@"
RuinsOfAlphName:     db "HONTO RUINS@"
...
Route5Name:          db "SOUTH POINT¯DOCKS@"
...
IlexForestName:      db "NIHON¯FOREST@"
BurnedTowerName:     db "MOUNTAIN¯CAVE@"
FastShipName:        db "FAST SHIP@"
ViridianForestName:  db "VIRIDIAN¯FOREST@"
DiglettsCaveName:    db "URUMA¯CAVERN@"
TohjoFallsName:      db "TOHJO FALLS@"
UndergroundName:     db "MT.MONWAL@"
