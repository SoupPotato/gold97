...
; pointers to the first map of each map group
	dw MapGroup_Alloy
	dw MapGroup_Sanskrit
	dw MapGroup_Dungeons
	dw MapGroup_Teknos
	dw MapGroup_BlueForest
	dw MapGroup_Frostpoint
	dw MapGroup_Nago
	dw MapGroup_Birdon
	dw MapGroup_Pagota
	dw MapGroup_Westport
	dw MapGroup_Amami
	dw MapGroup_Koban
	dw MapGroup_Kume
...
MapGroup_Alloy:
	...
	map AlloySpeechHouse, TILESET_HOUSE, INDOOR, ALLOY_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	...
	map Route109, TILESET_JOHTO_MODERN, ROUTE, ROUTE_109, MUSIC_ROUTE_37, FALSE, PALETTE_AUTO, FISHGROUP_QWILFISH
	...
	map Route107AlloyGate2F, TILESET_GATE, INDOOR, ROUTE_107, MUSIC_ROUTE_36, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map Route106, TILESET_JOHTO_MODERN, ROUTE, ROUTE_106, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_POND
...
MapGroup_Sanskrit:
	...
	map SanskritTown, TILESET_PARK, TOWN, SANSKRIT_TOWN, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map Boardwalk, TILESET_PARK, ROUTE, BOARDWALK, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_GUPGOLD
	map Route118, TILESET_PARK, ROUTE, ROUTE_118, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_CORASUN
...
MapGroup_Dungeons:
	...
	map SlowpokeWellB1F, TILESET_DARK_CAVE, CAVE, SLOWPOKE_WELL, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	...
	map CharredSummitCave, TILESET_DARK_CAVE, CAVE, CHARRED_SUMMIT, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	...
	map WhirlIslandB3F, TILESET_DARK_CAVE, CAVE, WHIRL_ISLAND, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_WHIRL_ISLANDS
	...
	map SilentHills, TILESET_FOREST, GATE, SILENT_HILLS, MUSIC_UNION_CAVE, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map TidalGrottoB1F, TILESET_DARK_CAVE, CAVE, TIDAL_GROTTO, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map TidalGrotto1F, TILESET_DARK_CAVE, CAVE, TIDAL_GROTTO, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
...
MapGroup_Teknos:
	...
	map Route119, TILESET_PARK, ROUTE, ROUTE_119, MUSIC_ROUTE_30, FALSE, PALETTE_AUTO, FISHGROUP_HORSEA
	map Route120, TILESET_PARK, ROUTE, ROUTE_120, MUSIC_ROUTE_30, FALSE, PALETTE_AUTO, FISHGROUP_POND
...
MapGroup_BlueForest:
	...
	map Route110, TILESET_BATTLE_TOWER, ROUTE, ROUTE_110, MUSIC_ROUTE_37, FALSE, PALETTE_AUTO, FISHGROUP_REMORAID
	map Route112, TILESET_BATTLE_TOWER, ROUTE, ROUTE_112, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map Route110SandstormHouse, TILESET_HOUSE, INDOOR, ROUTE_110, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map BlueForestGym, TILESET_ELITE_FOUR_ROOM, INDOOR, BLUE_FOREST, MUSIC_GYM, TRUE, PALETTE_NITE, FISHGROUP_NONE
...
MapGroup_Frostpoint:
	...
	map FrostpointTown, TILESET_BATTLE_TOWER, TOWN, FROSTPOINT_TOWN, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map Route111, TILESET_BATTLE_TOWER, ROUTE, ROUTE_111, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	...
	map FrostpointSpeechHouse, TILESET_HOUSE, INDOOR, FROSTPOINT_TOWN, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE

MapGroup_Nago:
	map NagoImposterHouse, TILESET_HOUSE, INDOOR, NAGO_VILLAGE, MUSIC_PALLET_TOWN, FALSE, PALETTE_DAY, FISHGROUP_NONE
	...
	map NagoVillage, TILESET_JOHTO_MODERN, TOWN, NAGO_VILLAGE, MUSIC_PALLET_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map NagoCharmanderHouse, TILESET_HOUSE, INDOOR, NAGO_VILLAGE, MUSIC_PALLET_TOWN, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map MotobuPath, TILESET_JOHTO_MODERN, ROUTE, MOTOBU_PATH, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map IeTown, TILESET_JOHTO_MODERN, TOWN, IE_TOWN, MUSIC_VERMILION_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map IeTMShop, TILESET_MART, INDOOR, IE_TOWN, MUSIC_VERMILION_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map IePokecenter1F, TILESET_POKECENTER, INDOOR, IE_TOWN, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map IeHouse1, TILESET_HOUSE, INDOOR, IE_TOWN, MUSIC_VERMILION_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map IeHouse2, TILESET_HOUSE, INDOOR, IE_TOWN, MUSIC_VERMILION_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map CastleMountain1F, TILESET_LIGHTHOUSE, CAVE, CASTLE_MOUNTAIN, MUSIC_LIGHTHOUSE, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map CastleMountain1FDanceHall, TILESET_LIGHTHOUSE, CAVE, CASTLE_MOUNTAIN, MUSIC_LIGHTHOUSE, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map CastleMountain1FDiningHall, TILESET_LIGHTHOUSE, CAVE, CASTLE_MOUNTAIN, MUSIC_LIGHTHOUSE, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map CastleMountain1FLongHall, TILESET_LIGHTHOUSE, CAVE, CASTLE_MOUNTAIN, MUSIC_LIGHTHOUSE, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map CastleMountain1FStairs, TILESET_LIGHTHOUSE, CAVE, CASTLE_MOUNTAIN, MUSIC_LIGHTHOUSE, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map CastleMountain1FCave, TILESET_CAVE, CAVE, CASTLE_MOUNTAIN, MUSIC_LIGHTHOUSE, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map CastleMountain2F, TILESET_LIGHTHOUSE, CAVE, CASTLE_MOUNTAIN, MUSIC_LIGHTHOUSE, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map CastleMountain3FA, TILESET_LIGHTHOUSE, CAVE, CASTLE_MOUNTAIN, MUSIC_LIGHTHOUSE, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map CastleMountain3FB, TILESET_LIGHTHOUSE, CAVE, CASTLE_MOUNTAIN, MUSIC_LIGHTHOUSE, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map CastleMountainB1F, TILESET_CAVE, CAVE, CASTLE_MOUNTAIN, MUSIC_LIGHTHOUSE, TRUE, PALETTE_NITE, FISHGROUP_DRATINI
...
MapGroup_Pagota:
	...
	map Route102WestportGate2F, TILESET_GATE, INDOOR, ROUTE_102, MUSIC_ROUTE_30, FALSE, PALETTE_DAY, FISHGROUP_NONE
	...
	map DragonsMaw, TILESET_DARK_CAVE, GATE, DRAGONS_MAW, MUSIC_DRAGONS_DEN, TRUE, PALETTE_NITE, FISHGROUP_DRATINI
...
MapGroup_Amami:
	map AmamiTown, TILESET_PARK, TOWN, AMAMI_TOWN, MUSIC_VERMILION_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map AmamiSpeechHouse, TILESET_HOUSE, INDOOR, AMAMI_TOWN, MUSIC_VERMILION_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	...
	map AmamiSuperRodHouse, TILESET_HOUSE, INDOOR, AMAMI_TOWN, MUSIC_VERMILION_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map AmamiBattleTowerGate, TILESET_GATE, GATE, BATTLE_TOWER, MUSIC_VERMILION_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Kume:
	map KumeCity, TILESET_JOHTO_MODERN, TOWN, KUME_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map KumePartsShop, TILESET_CHAMPIONS_ROOM, INDOOR, KUME_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map KumeSocialHouse, TILESET_HOUSE, INDOOR, KUME_CITY, MUSIC_VIRIDIAN_CITY, TRUE, PALETTE_DAY, FISHGROUP_NONE
	map KumePokecenter1F, TILESET_POKECENTER, INDOOR, KUME_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map KumeSnoozeSpeechHouse, TILESET_HOUSE, INDOOR, KUME_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map KumeMart, TILESET_MART, INDOOR, KUME_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map UrasoeTrail, TILESET_JOHTO_MODERN, ROUTE, URASOE_TRAIL, MUSIC_ROUTE_12, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map KeramaStrait, TILESET_JOHTO_MODERN, ROUTE, KERAMA_STRAIT, MUSIC_ROUTE_12, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map KumePoint, TILESET_JOHTO_MODERN, ROUTE, KUME_POINT, MUSIC_ROUTE_12, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map ForkedStrait, TILESET_JOHTO_MODERN, ROUTE, FORKED_STRAIT, MUSIC_ROUTE_12, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN ; new
	map ForkedStraitGate, TILESET_GATE, INDOOR, FORKED_STRAIT, MUSIC_ROUTE_12, FALSE, PALETTE_DAY, FISHGROUP_NONE ; new
	map ForkedStraitEastExit, TILESET_TROPICAL, ROUTE, FORKED_STRAIT, MUSIC_ROUTE_12, TRUE, PALETTE_AUTO, FISHGROUP_OCEAN ; new
	map TropicalIsland, TILESET_TROPICAL, ROUTE, TROPICAL_ISLAND, MUSIC_ROUTE_2, TRUE, PALETTE_AUTO, FISHGROUP_DRATINI ; new
	map TropicalIslandJungle, TILESET_TROPICAL, ROUTE, TROPICAL_ISLAND, MUSIC_ROUTE_2, TRUE, PALETTE_AUTO, FISHGROUP_NONE ; new

MapGroup_FastShip:
	map WestportPort, TILESET_PORT, ROUTE, WESTPORT_CITY, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map TeknosPort, TILESET_PORT, ROUTE, TEKNOS_CITY, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map AmamiPort, TILESET_PORT, ROUTE, AMAMI_TOWN, MUSIC_VERMILION_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Stand:
	...
	map StandSpeechHouse, TILESET_HOUSE, INDOOR, STAND_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	...
	map Route113, TILESET_JOHTO_MODERN, ROUTE, ROUTE_113, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_LAKE
...
MapGroup_Kanto:
	...
	map SafariZoneBeta, TILESET_FOREST, ROUTE, KANTO_REGION_M, MUSIC_EVOLUTION, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map KantoPowerPlant, TILESET_UNDERGROUND, CAVE, KANTO_REGION_M, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map SeafoamIslands1F, TILESET_CAVE, CAVE, KANTO_REGION_M, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_WHIRL_ISLANDS
	map SeafoamIslandsB1F, TILESET_CAVE, CAVE, KANTO_REGION_M, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_WHIRL_ISLANDS
	map KantoMuseum1F, TILESET_MUSEUM, INDOOR, KANTO_REGION_M, MUSIC_VIRIDIAN_CITY, TRUE, PALETTE_DAY, FISHGROUP_NONE
	map KantoMuseum2F, TILESET_MUSEUM, INDOOR, KANTO_REGION_M, MUSIC_VIRIDIAN_CITY, TRUE, PALETTE_DAY, FISHGROUP_NONE
	map PokemonTower1F, TILESET_GRAVEYARD, CAVE,KANTO_REGION_M, MUSIC_LAVENDER_TOWN, TRUE, PALETTE_DAY, FISHGROUP_NONE
	map PokemonTower2F, TILESET_GRAVEYARD, CAVE,KANTO_REGION_M, MUSIC_LAVENDER_TOWN, TRUE, PALETTE_DAY, FISHGROUP_NONE
	map PokemonTower3F, TILESET_GRAVEYARD, CAVE,KANTO_REGION_M, MUSIC_LAVENDER_TOWN, TRUE, PALETTE_DAY, FISHGROUP_NONE
	map TrainerHouse1F, TILESET_HOUSE, INDOOR, KANTO_REGION_M, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map TrainerHouseB1F, TILESET_FACILITY, INDOOR, KANTO_REGION_M, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map KantoFujiHouse, TILESET_HOUSE, INDOOR, KANTO_REGION_M, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map KantoDock, TILESET_PORT, INDOOR, KANTO_REGION_M, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN


MapGroup_Sunpoint:
	map SunpointCity, TILESET_BATTLE_TOWER_OUTSIDE, TOWN, SUNPOINT_CITY, MUSIC_AZALEA_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map SunpointDocks, TILESET_PORT, ROUTE, SUNPOINT_DOCKS, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map SunPointDocksSunPointGate, TILESET_GATE, GATE, SUNPOINT_DOCKS, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map SunpointMart, TILESET_MART, INDOOR, SUNPOINT_CITY, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_NONE
	...
	map SkateboarderHouse, TILESET_HOUSE, INDOOR, SUNPOINT_CITY, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_NONE
...
MapGroup_Silent:
	...
	map Route101PagotaGate2F, TILESET_GATE, INDOOR, ROUTE_101, MUSIC_ROUTE_29, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map VictoryRoadGate, TILESET_GATE, GATE, VICTORY_ROAD, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_DAY, FISHGROUP_NONE

MapGroup_Ryukyu:
	map RyukyuCity, TILESET_BATTLE_TOWER_OUTSIDE, TOWN, RYUKYU_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map RyukyuFakeGym, TILESET_ICE_PATH, INDOOR, RYUKYU_CITY, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_NONE
	map RyukyuMart, TILESET_MART, INDOOR, RYUKYU_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map RyukyuPokecenter1F, TILESET_POKECENTER, INDOOR, RYUKYU_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map RyukyuTradeHouse, TILESET_HOUSE, INDOOR, RYUKYU_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map RyukyuArboretum, TILESET_BATTLE_TOWER_OUTSIDE, INDOOR, RYUKYU_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map UrasoePark, TILESET_BATTLE_TOWER_OUTSIDE, ROUTE, URASOE_PARK, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map RyukyuTradeSpeechHouse, TILESET_HOUSE, INDOOR, RYUKYU_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map UrasoeParkUrasoeTrailGate, TILESET_GATE, GATE, URASOE_PARK, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map RyukyuHotel, TILESET_POKECOM_CENTER, INDOOR, RYUKYU_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map RyukyuHotel2F, TILESET_MANSION, INDOOR, RYUKYU_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map RyukyuHotel3F, TILESET_MANSION, INDOOR, RYUKYU_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map RyukyuHotel4F, TILESET_MANSION, INDOOR, RYUKYU_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map RyukyuHotel5F, TILESET_MANSION, INDOOR, RYUKYU_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map RyukyuHotelRooms, TILESET_POKECOM_CENTER, INDOOR, RYUKYU_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map RyukyuElevator, TILESET_GAME_CORNER, INDOOR, RYUKYU_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map RyukyuRestaurant, TILESET_GAME_CORNER, INDOOR, RYUKYU_CITY, MUSIC_GAME_CORNER, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map RyukyuTheatre, TILESET_GAME_CORNER, INDOOR, RYUKYU_CITY, MUSIC_GAME_CORNER, TRUE, PALETTE_DAY, FISHGROUP_NONE
...
MapGroup_Crown:
	...
	map CrownCity, TILESET_JOHTO_MODERN, TOWN, CROWN_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_POND
	...
	map ForkedStraitWestExit, TILESET_TROPICAL, ROUTE, FORKED_STRAIT, MUSIC_ROUTE_12, TRUE, PALETTE_AUTO, FISHGROUP_OCEAN ; new
	map RainbowIslandCave, TILESET_DARK_CAVE, CAVE, RAINBOW_ISLAND, MUSIC_UNION_CAVE_SLOW, TRUE, PALETTE_NITE, FISHGROUP_SHORE ; new
	
MapGroup_Rainbow:
	map RainbowIsland, TILESET_TROPICAL, ROUTE, RAINBOW_ISLAND, MUSIC_ROUTE_2, TRUE, PALETTE_AUTO, FISHGROUP_SHORE ; new
	
MapGroup_Kikai:
	map BattleTowerOutside, TILESET_JOHTO_MODERN, ROUTE, BATTLE_TOWER, MUSIC_BATTLE_TOWER_THEME, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map TatsugoPath, TILESET_JOHTO_MODERN, ROUTE, TATSUGO_PATH, MUSIC_ROUTE_12, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map KikaiStrait, TILESET_JOHTO_MODERN, ROUTE, KIKAI_STRAIT, MUSIC_ROUTE_12, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map KikaiVillage, TILESET_JOHTO_MODERN, TOWN, KIKAI_VILLAGE, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map KikaiPokecenter1F, TILESET_POKECENTER, INDOOR, KIKAI_VILLAGE, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map KikaiMart, TILESET_MART, INDOOR, KIKAI_VILLAGE, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map KikaiHouse1, TILESET_HOUSE, INDOOR, KIKAI_VILLAGE, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map KikaiHouse2, TILESET_HOUSE, INDOOR, KIKAI_VILLAGE, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map KikaiCaldera1F, TILESET_ICE_PATH, CAVE, KIKAI_CALDERA, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map KikaiCaldera2F, TILESET_ICE_PATH, CAVE, KIKAI_CALDERA, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map KikaiCaldera3F, TILESET_ICE_PATH, CAVE, KIKAI_CALDERA, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_NONE

MapGroup_Daito:
	map GreatEastStrait, TILESET_PARK, ROUTE, GREAT_EAST_STRAIT, MUSIC_ROUTE_12, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map DaitoRanch, TILESET_PARK, TOWN, DAITO_RANCH, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map DaitoAppleOrchard, TILESET_PARK, ROUTE, APPLE_ORCHARD, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map DaitoRanchHouse, TILESET_HOUSE, INDOOR, DAITO_RANCH, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map DaitoRanchBarn, TILESET_TRADITIONAL_HOUSE, INDOOR, DAITO_RANCH, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map AppleOrchardHouse, TILESET_HOUSE, INDOOR, APPLE_ORCHARD, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map DaitoGardenerGeoffHouse, TILESET_HOUSE, INDOOR, DAITO_RANCH, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_NONE
