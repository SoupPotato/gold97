...
MapGroup_Yoron:
	map YoronCity, TILESET_JOHTO_MODERN, TOWN, YORON_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_AUTO, FISHGROUP_QWILFISH
	...
	map YoronPoint, TILESET_JOHTO_MODERN, ROUTE, YORON_POINT, MUSIC_ROUTE_12, FALSE, PALETTE_AUTO, FISHGROUP_QWILFISH
