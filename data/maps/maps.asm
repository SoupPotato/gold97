...
MapGroup_Yoron:
	...
	map ForkedStraitEastExit, TILESET_BATTLE_TOWER_OUTSIDE, ROUTE, FORKED_STRAIT, MUSIC_ROUTE_12, TRUE, PALETTE_AUTO, FISHGROUP_OCEAN ; new
	map TropicalIsland, TILESET_BATTLE_TOWER_OUTSIDE, ROUTE, TROPICAL_ISLAND, MUSIC_ROUTE_2, TRUE, PALETTE_AUTO, FISHGROUP_DRATINI ; new
	map TropicalIslandJungle, TILESET_BATTLE_TOWER_OUTSIDE, ROUTE, TROPICAL_ISLAND, MUSIC_ROUTE_2, TRUE, PALETTE_AUTO, FISHGROUP_NONE ; new
...
MapGroup_Crown:
	...
	map ForkedStraitWestExit, TILESET_BATTLE_TOWER_OUTSIDE, ROUTE, FORKED_STRAIT, MUSIC_ROUTE_12, TRUE, PALETTE_AUTO, FISHGROUP_OCEAN ; new
	map RainbowIsland, TILESET_BATTLE_TOWER_OUTSIDE, ROUTE, RAINBOW_ISLAND, MUSIC_ROUTE_2, TRUE, PALETTE_AUTO, FISHGROUP_SHORE ; new
