...
BugsyGroup:
	...
	db 18, LEDIAN,     SUPERSONIC, COMET_PUNCH, LIGHT_SCREEN, NO_MOVE
...
PryceGroup:
	...
	db 38, WARFARU,   ICE_PUNCH, SLASH, SWAGGER, LOW_KICK
	db -1 ; end
...
Rival1Group:
	...
	db 34, BELLRING,  HEADBUTT, BITE, DISABLE, SWIFT;bellring
	db 34, BOMSEAL,    DOUBLE_TEAM, BUBBLEBEAM, FLAME_WHEEL, NO_MOVE;bomseal
	...
	db 44, BELLRING,   HEADBUTT, BITE, DOUBLE_TEAM, SLASH;bellring
	db 44, BOMSEAL,    DOUBLE_TEAM, BUBBLEBEAM, FLAME_WHEEL, FIRE_SPIN;bomseal
	db 45, RAITORA,    THUNDER_WAVE, THUNDERBOLT, MUD_SLAP, SLASH;raitora
	db 45, CURPAN,     PAIN_SPLIT, SHADOW_BALL, PSYBEAM, BODY_SLAM;curpan
...
WillGroup:
	...
	db 53, WARFARU,    SLASH, BLIZZARD, LOW_KICK, CONFUSE_RAY
...
BrunoGroup:
	...
	db 54, CURPAN,   PAIN_SPLIT, SHADOW_BALL, REFLECT, PERISH_SONG
...
CooltrainerFGroup:
	...
	db 47, BIPETAL,  SUNNY_DAY, SOLARBEAM, RAZOR_LEAF, ACID
	db -1 ; end
...
SabrinaGroup:
	...
	db 36, ANIMON,   TRANSFORM, NO_MOVE, NO_MOVE, NO_MOVE
...
BugCatcherGroup:
	...
	db 11, PARA,	SCRATCH, STUN_SPORE, POISONPOWDER, NO_MOVE
...
Rival2Group:
	...
	db 54, BELLRING,   HEADBUTT, GLARE, MUD_SLAP, FAINT_ATTACK;bellring
	db 56, BOMSEAL,    DOUBLE_TEAM, BUBBLEBEAM, FLAME_WHEEL, TAKE_DOWN;bomseal
	...
	db 54, CURPAN,     CONFUSE_RAY, PAIN_SPLIT, PSYCHIC_M, SHADOW_BALL;curpan
	db -1 ; end
