...
PryceGroup:
	...
	db 35, CLOYSTER,  ICY_WIND, PROTECT, CLAMP, SWAGGER
	db 38, WARWOLF,   ICE_PUNCH, SLASH, CONFUSE_RAY, LOW_KICK
	db -1 ; end
	...
	db 67, WARWOLF,  NEVERMELTICE,  ICE_PUNCH, SLASH, SWORDS_DANCE, LOW_KICK
	db -1 ; end
...
OkeraGroup:
	...
	db 40, SNEASEL,  DIG, THIEF, ICE_PUNCH, SLASH
	...
	db 63, SNEASEL, BRIGHTPOWDER, SLASH, ICE_BEAM, THIEF, FURY_CUTTER
...
Rival1Group:
	...
	db 20, BOMSHEAL,  LICK, WATER_GUN, FLAME_WHEEL, NO_MOVE
	db 22, PETAMOLE,    GROWTH, TACKLE, RAZOR_LEAF, STUN_SPORE
	db -1 ; end
...
GiovanniE4Group:
	...
	db 58, NIDOKING,   MEGAHORN, EARTHQUAKE, SLUDGE_BOMB, HYPER_BEAM
	db 62, RHYDON,     ROCK_SLIDE, DOUBLE_EDGE, EARTHQUAKE, SURF
	db -1 ; end
	...
	db 68, NIDOKING, BERSERK_GENE,  MEGAHORN, EARTHQUAKE, SLUDGE_BOMB, HYPER_BEAM
	db 72, RHYDON, HARD_STONE, ROCK_SLIDE, DOUBLE_EDGE, EARTHQUAKE, SURF
	db -1 ; end
...
GiovanniGroup:
	...
	db 44, NIDOKING,   MEGAHORN, EARTHQUAKE, SLUDGE_BOMB, HYPER_BEAM
	db 47, RHYDON,     ROCK_SLIDE, STOMP, EARTHQUAKE, SCARY_FACE
	db -1 ; end
...
ScientistGroup:
	; SCIENTIST (1)
	db "ROSS@", TRAINERTYPE_MOVES; used, base b2f
	db 38, PORYGON, TRI_ATTACK, RECOVER, AGILITY, PSYBEAM
	db 38, PORYGON2, TRI_ATTACK, RECOVER, AGILITY, PSYBEAM
	db -1 ; end
	...
	db 42, PORYGON2,    ICE_BEAM, PSYBEAM, RECOVER, TRI_ATTACK
	db -1 ; end
...
ImposterOakGroup:
	...
	db 42, VENUSAUR,    DOUBLE_EDGE, GIGA_DRAIN, SLUDGE_BOMB, SLEEP_POWDER
	db 42, BLASTOISE,   RAIN_DANCE, SURF, BITE, ICE_PUNCH
	db 42, CHARIZARD,   DRAGON_RAGE, SMOKESCREEN, FLAMETHROWER, WING_ATTACK
	db -1 ; end
...
SuperNerdGroup:
	...
	; SUPER_NERD (8)
	db "PAT@", TRAINERTYPE_MOVES; used, route 25
	db 52, PORYGON, TRI_ATTACK, RECOVER, LOCK_ON, ZAP_CANNON
	db 52, PORYGON2, TRI_ATTACK, RECOVER, LOCK_ON, ZAP_CANNON
	db -1 ; end
	...
	; SUPER_NERD (12)
	db "NORTON@", TRAINERTYPE_MOVES ; used, tatsugo path
	db 48, MUK, SLUDGE_BOMB, ACID_ARMOR, SCREECH, MINIMIZE
	db 52, PORYGON2, TRI_ATTACK, PSYBEAM, LOCK_ON, ZAP_CANNON
	db -1 ; end
...
ExecutiveMGroup:
	...
	db 43, PANGSHI,   CRUNCH, CONFUSE_RAY, BODY_SLAM, SHADOW_BALL
	db -1 ; end
	...
	db 45, PANGSHI,   PAIN_SPLIT, CONFUSE_RAY, BODY_SLAM, SHADOW_BALL
	db -1 ; end
