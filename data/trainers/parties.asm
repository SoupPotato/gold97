...
PKMNTrainerGroup:
	...
	; CAL (3) ;THIS IS USED NOW :^)
	db "CAL@", TRAINERTYPE_MOVES
	db 50, MEGANIUM, LEECH_SEED, REFLECT, LIGHT_SCREEN, PETAL_DANCE
	db 50, DYNABEAR, FLAMETHROWER, CRUNCH, DOUBLE_TEAM, REST
	db 50, AQUARIUS, BODY_SLAM, ICE_BEAM, HYDRO_PUMP, SAFEGUARD
	db 50, UMBREON, TOXIC, MOONLIGHT, SLUDGE_BOMB, BITE
	db 50, SKARMORY, STEEL_WING, PROTECT, DRILL_PECK, WHIRLWIND
	db 50, DONPHAN, EARTHQUAKE, ROCK_SLIDE, FLAIL, SCARY_FACE
	db -1 ; end
