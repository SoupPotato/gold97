...
FalknerGroup:
	...
	db  60, FEAROW, SHARP_BEAK, FAINT_ATTACK, DRILL_PECK, STEEL_WING, AGILITY
	db  61, MADAME, KINGS_ROCK, SWORDS_DANCE, SLASH, SKY_ATTACK, FAINT_ATTACK
	...
	db  62, XATU, SHARP_BEAK, CONFUSE_RAY, PSYCHIC_M, DRILL_PECK, SHADOW_BALL
	db  64, PIDGEOT, SHARP_BEAK,  PROTECT, MUD_SLAP, RAZOR_WIND, WING_ATTACK
	db -1 ; end
...
WhitneyGroup:
	...
	db 64, WIGGLYTUFF, PINK_BOW, SWEET_KISS, SING, BODY_SLAM, REST
...
BugsyGroup:
	...
	db 18, TRIPSTAR,     SUPERSONIC, COMET_PUNCH, LIGHT_SCREEN, MACH_PUNCH
	db 20, PINSIR,    VICEGRIP, FOCUS_ENERGY, FURY_CUTTER, BIND
	db -1 ; end

	db "BUGSY@", TRAINERTYPE_ITEM_MOVES ;rematch
	db 63, TUHEAD, SILVERPOWDER,   PIN_MISSILE, PSYCHIC_M, SLUDGE_BOMB, SPIDER_WEB
	db 61, VENOMOTH, BRIGHTPOWDER,  SLEEP_POWDER, PSYCHIC_M, SLUDGE_BOMB, SUPERSONIC
	db 63, TRIPSTAR, GOLD_BERRY, SUPERSONIC, REFLECT, LIGHT_SCREEN, DOUBLE_EDGE
	...
	db 64, PRAXE, SCOPE_LENS, METAL_CLAW, SUBMISSION, MEGAHORN, FOCUS_ENERGY
	db -1 ; end

MortyGroup:
	; MORTY (1)
	db "MORTY@", TRAINERTYPE_MOVES; used
	...
	db "MORTY@", TRAINERTYPE_ITEM_MOVES; rematch
	db 64, TWINZ, GOLD_BERRY, CONFUSE_RAY, PAIN_SPLIT, SHADOW_BALL, MEAN_LOOK
	db 62, PANGSHI, SPELL_TAG,  PSYBEAM, CURSE, CONFUSE_RAY, MEAN_LOOK
	...
	db 63, PANGSHI, NO_ITEM, SHADOW_BALL, PERISH_SONG, CONFUSE_RAY, PAIN_SPLIT
...
PryceGroup:
	...
	db 64, DELIBIRD, NEVERMELTICE, BLIZZARD, HEAL_BELL, HAZE, DRILL_PECK
	...
	db 67, WARWOLF,  NEVERMELTICE,  ICE_PUNCH, SLASH, SWAGGER, LOW_KICK
	db -1 ; end
...
JasmineGroup:
	...
	db 62, MAGNETON, MAGNET,  THUNDERBOLT, SUPERSONIC, LIGHT_SCREEN, THUNDER_WAVE
	db 63, METTO, MYSTERYBERRY,  TRANSFORM, NO_MOVE, NO_MOVE, NO_MOVE
	db 63, SKARMORY, BRIGHTPOWDER, PROTECT, MUD_SLAP, STEEL_WING, DRILL_PECK
	db 62, MAGNETON, MAGNET,  LIGHT_SCREEN, ZAP_CANNON, LOCK_ON, THUNDER_WAVE
	db 64, GROTESS, GOLD_BERRY, SURF, CRUNCH, IRON_TAIL, ACID_ARMOR
	db 65, STEELIX, METAL_COAT, EARTHQUAKE, SANDSTORM, ROCK_HEAD, IRON_TAIL
	db -1 ; end
...
ChuckGroup:
	...
	db 64, MURKROW, NO_ITEM,  DRILL_PECK, THIEF, STEEL_WING, DETECT
	db 63, GIRAFARIG, MIRACLEBERRY,  CONFUSE_RAY, PSYCHIC_M, PAIN_SPLIT, CRUNCH
	db 64, BELLRUN, BLACKGLASSES, GLARE, DISABLE, PURSUIT, ATTRACT
...
ClairGroup:
	; CLAIR (1) ; used postgame now
	db "CLAIR@", TRAINERTYPE_ITEM_MOVES
	db 67, DRAGONAIR, MYSTIC_WATER,  THUNDER_WAVE, SURF, SLAM, DRAGONBREATH
	db 64, AMPHAROS, BRIGHTPOWDER, THUNDER, CONFUSE_RAY, LIGHT_SCREEN, COTTON_SPORE
	db 67, DRAGONAIR, MAGNET,  THUNDER_WAVE, THUNDERBOLT, SLAM, DRAGONBREATH
	db 64, ARCANINE, BITTER_BERRY, CRUNCH, OUTRAGE, FIRE_BLAST, EXTREMESPEED
	db 67, DRAGONAIR, NEVERMELTICE,  THUNDER_WAVE, ICE_BEAM, SLAM, DRAGONBREATH
	db 70, KINGDRA, MIRACLEBERRY, SMOKESCREEN, SURF, HYPER_BEAM, DRAGONBREATH
	db -1 ; end
...
WillGroup:
	...
	db 64, DEWGONG, MINT_BERRY, ICE_BEAM, SURF, REST, SAFEGUARD
	db 65, CLOYSTER, LEFTOVERS, SPIKE_CANNON, ICE_BEAM, HYDRO_PUMP, BARRIER
	db 65, JYNX, TWISTEDSPOON,  PSYCHIC_M, LOVELY_KISS, ICE_PUNCH, BODY_SLAM
	db 64, AQUARIUS, MYSTERYBERRY,  HYDRO_PUMP, ICE_BEAM, BODY_SLAM, SAFEGUARD
	db 65, WARWOLF, NEVERMELTICE,    SLASH, BLIZZARD, LOW_KICK, CONFUSE_RAY
	db 67, LAPRAS, NEVERMELTICE,  BODY_SLAM, BLIZZARD, SURF, PSYCHIC_M
	db -1 ; end
...
PKMNTrainerGroup:
	...
	; CAL (3) ;THIS IS USED NOW :^) Nerfed levels from 50 so he isn't stronger than red when you get to kanto region
	db "CAL@", TRAINERTYPE_MOVES
	db 40, MEGANIUM, LEECH_SEED, REFLECT, LIGHT_SCREEN, PETAL_DANCE
	db 40, DYNABEAR, FLAMETHROWER, CRUNCH, DOUBLE_TEAM, REST
	db 40, AQUARIUS, BODY_SLAM, ICE_BEAM, HYDRO_PUMP, SAFEGUARD
	db 40, UMBREON, TOXIC, MOONLIGHT, SLUDGE_BOMB, BITE
	db 40, SKARMORY, STEEL_WING, PROTECT, DRILL_PECK, WHIRLWIND
	db 40, DONPHAN, EARTHQUAKE, ROCK_SLIDE, FLAIL, SCARY_FACE
	db -1 ; end
...
BrunoGroup:
	...
	db 66, PANGSHI, SPELL_TAG,   PAIN_SPLIT, SHADOW_BALL, REFLECT, PERISH_SONG
	db 64, BELLRUN, MIRACLEBERRY,  PURSUIT, SLASH, GLARE, ATTRACT
	db 68, MAROWAK, METAL_COAT,  DOUBLE_EDGE, BONEMERANG, ANCIENTPOWER, IRON_TAIL
...
KarenGroup:
	...
	db 66, PERSIAN, SCOPE_LENS,   FAINT_ATTACK, SLASH, MUD_SLAP, THUNDERBOLT
	db 66, NIDOQUEEN, POISON_BARB,  SUBMISSION, BODY_SLAM, SLUDGE_BOMB, ICE_BEAM
	db 68, KANGASKHAN, LEFTOVERS, DIZZY_PUNCH, ATTRACT, CRUNCH, FIRE_BLAST
	db 67, DUGTRIO, SOFT_SAND, EARTHQUAKE, FISSURE, TRI_ATTACK, SAND_ATTACK
	db 68, RHYDON, HARD_STONE, ROCK_SLIDE, DOUBLE_EDGE, EARTHQUAKE, SURF
	db 72, NIDOKING, BERSERK_GENE,  MEGAHORN, EARTHQUAKE, SLUDGE_BOMB, HYPER_BEAM
	db -1 ; end

KogaGroup:
	; KOGA (1)
	db "KOGA@", TRAINERTYPE_MOVES
	db 52, TUHEAD,    DOUBLE_TEAM, PIN_MISSILE, TOXIC, PSYCHIC_M
	...
	db 64, TUHEAD, TWISTEDSPOON,   DOUBLE_TEAM, PIN_MISSILE, TOXIC, PSYCHIC_M
	...
	db 66, TURBAN, QUICK_CLAW, CRUNCH, HYDRO_PUMP, PROTECT, SLUDGE_BOMB
	db 67, WEEZING, POISON_BARB,   SLUDGE_BOMB, FLAMETHROWER, DESTINY_BOND, TOXIC
...
ChampionGroup:
	...
	db 75, DRAGONITE, BITTER_BERRY,  FIRE_BLAST, SAFEGUARD, OUTRAGE, HYPER_BEAM
	db -1 ; end
...
LtSurgeGroup: ; used in kanto power plant now :^)
	; LT_SURGE (1)
...
BirdKeeperGroup:
	...
	; BIRD_KEEPER (14)
	db "JOSE@", TRAINERTYPE_NORMAL; unused
	db 35, FARFETCH_D
	db 36, MADAME
	db -1 ; end
	...
	; BIRD_KEEPER (17)
	db "JOSE@", TRAINERTYPE_MOVES; unused
...
JanineGroup:
	...
	db 60, STEELIX, HARD_STONE, ROCK_HEAD, EARTHQUAKE, IRON_TAIL, DRAGONBREATH
	db 62, HITMONCHAN, DETECT_ORB, MACH_PUNCH, COUNTER, THUNDERPUNCH, ICE_PUNCH
	db 62, HITMONLEE, FOCUS_ORB,  HI_JUMP_KICK, FORESIGHT, REVERSAL, MEGA_KICK
	db 62, HITMONTOP, BLACKBELT,   TRIPLE_KICK, DETECT, COUNTER, PURSUIT
	db 61, POLIWRATH, APPLE,  HYDRO_PUMP, BELLY_DRUM, BODY_SLAM, DYNAMICPUNCH
	db 64, MACHAMP, BLACKBELT, CROSS_CHOP, ROCK_SLIDE, EARTHQUAKE, SWAGGER
	db -1 ; end
...
CooltrainerMGroup:
	...
	; COOLTRAINERM (6)
	db "GAVEN@", TRAINERTYPE_NORMAL ;used, kanto victory road
	db 38, VICTREEBEL
	db 38, KINGLER
	db 40, FLAREON
	db -1 ; end
	...
	; COOLTRAINERM (8) 
	db "RYAN@", TRAINERTYPE_NORMAL ;unused, going to use somewhere else
	db 25, PIDGEOT
	db 27, ELECTABUZZ
	db -1 ; end
...
CooltrainerFGroup:
	...
	; COOLTRAINERF (9)
	db "BETH@", TRAINERTYPE_NORMAL ;used, kanto victory road
	db 41, RAPIDASH
	db 42, AMPHAROS
	db -1 ; end
	...
	; COOLTRAINERF (12)
	db "KENZIE@", TRAINERTYPE_NORMAL ;used, kanto victory road
	db 39, PIDGEOT
	db 40, ARCANINE
	db 41, GYARADOS
	db -1 ; end
	...
	; COOLTRAINERF (18)
	db "ALLY@", TRAINERTYPE_NORMAL ;used, kanto victory road (funfact, if you count the number of heads her pokemon have, there's 7! Just like her badge dialog)
	db 40, DODRIO
	db 43, MAGNETON
	db 42, SLOWKING
	db -1 ; end
	...
	; COOLTRAINERF (19)
	db "REENA@", TRAINERTYPE_NORMAL; unused
	db 34, WARWOLF
	db 36, NIDOQUEEN
	db 34, LICKILORD
	db -1 ; end
	...
	; COOLTRAINERF (20)
	db "REENA@", TRAINERTYPE_ITEM_MOVES; unused
...
GruntMGroup:
	...
	; GRUNTM (31)
	db "GRUNT@", TRAINERTYPE_NORMAL ;used, castle mountain
	db 60, GOLBAT
	db -1 ; end
	
	; GRUNTM (32)
	db "GRUNT@", TRAINERTYPE_NORMAL ; used teknos city
	db 17, RATTATA
	db 17, GRIMBY
	db -1 ; end
	...
	db 57, SMEARGLE, MEAN_LOOK, SPORE, LEECH_SEED, DREAM_EATER
	db -1
...
FisherGroup:
	...
	; FISHER (11)
	db "EDGAR@", TRAINERTYPE_MOVES ; used, forked strait, the final boss of fishing (and the last regular trainer in the whole game)
	db 58, OCTILLERY, ZAP_CANNON, LOCK_ON, OCTAZOOKA, ICE_BEAM
	...
	db 60, STARMIE, PSYCHIC_M, HYDRO_PUMP, THUNDERBOLT, RECOVER
...
ExecutiveFGroup:
	; EXECUTIVEF (1)
	db "EXECUTIVE@", TRAINERTYPE_ITEM_MOVES; used, castle mountain
	db 63, ARBOK, POISON_BARB, HAZE, SLUDGE_BOMB, CRUNCH, GLARE
	db 64, MURKROW, FOCUS_BAND, MEAN_LOOK, FAINT_ATTACK, PERISH_SONG, DRILL_PECK
	db 63, VILEPLUME, BITTER_BERRY,  PETAL_DANCE, MOONLIGHT, SLEEP_POWDER, SLUDGE_BOMB
	db 64, KABUTOPS, ENERGY_WALL,   SURF, CROSS_CUTTER, GIGA_DRAIN, ANCIENTPOWER
	db 65, LICKILORD, BITTER_BERRY,  THRASH, AMNESIA, SUPERSONIC, DISABLE
	db -1 ; end
...
BlueGroup:
	; BLUE (1) ; going to be used in postgame - cam
	...
	db 74, PRAXE, SCOPE_LENS, METAL_CLAW, SUBMISSION, MEGAHORN, SWORDS_DANCE
	db 77, ARCANINE, CHARCOAL, FLAMETHROWER, SUNNY_DAY, CRUNCH, REVERSAL
	db 75, MACHAMP, KINGS_ROCK, CROSS_CHOP, ROCK_SLIDE, EARTHQUAKE, ATTRACT
...
EngineerGroup:; use super nerd sprite
	...
	; ENGINEER (4)
	db "HARRIS@", TRAINERTYPE_MOVES ;used, route 117
