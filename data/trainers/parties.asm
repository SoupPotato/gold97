...
JanineGroup:
	...
	db 36, WEEZING,    SMOG, SLUDGE_BOMB, TOXIC, EXPLOSION
	db 33, TUHEAD,    SCARY_FACE, GIGA_DRAIN, STRING_SHOT, NIGHT_SHADE
...
BlueGroup:
	...
	db 81, UMBREON, LEFTOVERS, TOXIC, SLUDGE_BOMB, SHADOW_BALL, MOONLIGHT
	db 73, AERODACTYL, SCOPE_LENS, ANCIENTPOWER, EARTHQUAKE, WING_ATTACK, WHIRLWIND
	db 77, GYARADOS, BITTER_BERRY, SURF, FIRE_BLAST, THRASH, SWAGGER
	db 77, ARCANINE, CHARCOAL, FLAMETHROWER, SUNNY_DAY
