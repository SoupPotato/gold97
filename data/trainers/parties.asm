...
WhitneyGroup:
	...
	db 20, SNUBBULL,   HEADBUTT, CONFUSION, BITE, CHARM
	...
	db 64, SNUBBULL, PINK_BOW, SWEET_KISS, PERISH_SONG, PSYCHIC_M, SAFEGUARD
...
PryceGroup:
	...
	db 36, DELIBIRD, PRESENT, ICY_WIND, MEGAPHONE, FLY
...
JasmineGroup:
	...
	db 33, ANCHORAGE, SURF, IRON_TAIL, SUPERSONIC, PROTECT 
...
OkeraGroup:
	...
	db 39, MURKROW, TOXIC, PURSUIT, CONFUSE_RAY, AGILITY
