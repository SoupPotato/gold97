...
; CAM's NOTES:
; all the stats are hardcoded here so I had to use a smogon calculator with the
; new mons base stats, for ease I just acted like they had perfect DVs and stat exp
; instead of whatever data is listed with the mons here. Nobody will notice right? :^)))

; for that matter why IS there DVs and stat exp listed here? The stats aren't 
; being calculated from them, so literally what is the point of it being here.
...
BattleTowerMons1:
	...
	db QWILFISH ; DONE
	db SCOPE_LENS
	db SURF, SPIKES, MINIMIZE, SLUDGE_BOMB
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 40000
...
BattleTowerMons2:
	...
	db PINSIR ; DONE
	db FOCUS_BAND
	db ENDURE, SEISMIC_TOSS, MEGAHORN, EARTHQUAKE
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 50000
...
BattleTowerMons4:
	...
	db PORYGON2
	db NO_ITEM
	db TRI_ATTACK, CONVERSION, PSYBEAM, THIEF
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
...
BattleTowerMons5:
	...
	db RAITORA ; DONE
	db LEFTOVERS
	db THUNDERBOLT, REST, CRUNCH, PROTECT
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 60000
...
BattleTowerMons6:
	...
	db LICKILORD ; DONE
	db GOLD_BERRY
	db THRASH, SUPERSONIC, AMNESIA, HYPER_BEAM
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 55000
	...
	db LEAFEON ; DONE
	db FOCUS_BAND
	db SOLARBEAM, SLEEP_POWDER, SYNTHESIS, SUNNY_DAY
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 50000
...
BattleTowerMons8:
	...
	db LICKILORD ; DONE
	db MIRACLEBERRY
	db THRASH, SUPERSONIC, AMNESIA, EARTHQUAKE
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db RAITORA ; DONE
	db BRIGHTPOWDER
	db CRUNCH, THUNDERBOLT, THUNDER_WAVE, SLASH
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 30000
...
BattleTowerMons9:
	...
	db MEGANIUM ; DONE
	db LEFTOVERS
	db SOLARBEAM, SUNNY_DAY, LIGHT_SCREEN, TOXIC
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 50000
...
BattleTowerMons10:
	...
	db RAITORA ; DONE
	db QUICK_CLAW
	db THUNDER, RAIN_DANCE, ZAP_CANNON, CRUNCH
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 30000
