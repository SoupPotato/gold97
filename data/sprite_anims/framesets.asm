...
.Frameset_GS_INTRO_AERODACTYL:
	frame SPRITE_ANIM_OAMSET_INTRO_AERODACTYL_1,  30, OAM_X_FLIP
	frame SPRITE_ANIM_OAMSET_INTRO_AERODACTYL_1,  10, OAM_X_FLIP
	frame SPRITE_ANIM_OAMSET_INTRO_AERODACTYL_2,  24, OAM_X_FLIP
	frame SPRITE_ANIM_OAMSET_INTRO_AERODACTYL_2,  48, OAM_X_FLIP
	frame SPRITE_ANIM_OAMSET_INTRO_AERODACTYL_1,  10, OAM_X_FLIP
	dorestart
