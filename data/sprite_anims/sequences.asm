...
; entries correspond to SPRITE_ANIM_INDEX_* constants
	...
	db SPRITE_ANIM_FRAMESET_INTRO_PICHU,              SPRITE_ANIM_SEQ_INTRO_PICHU_ANCHORAGE,   $00 ; SPRITE_ANIM_INDEX_INTRO_PICHU
	db SPRITE_ANIM_FRAMESET_INTRO_ANCHORAGE,          SPRITE_ANIM_SEQ_INTRO_PICHU_ANCHORAGE,   $00 ; SPRITE_ANIM_INDEX_INTRO_ANCHORAGE
	...
	db SPRITE_ANIM_FRAMESET_GS_INTRO_CRUIZE,          SPRITE_ANIM_SEQ_GS_INTRO_CHIKORITA_CRUIZE, 0
	db SPRITE_ANIM_FRAMESET_GS_INTRO_FLAMBEAR,        SPRITE_ANIM_SEQ_GS_INTRO_FLAMBEAR,         0
	db SPRITE_ANIM_FRAMESET_GS_INTRO_CHIKORITA,       SPRITE_ANIM_SEQ_GS_INTRO_CHIKORITA_CRUIZE, 0
