	...
	tilecoll FLOOR, DOWN_WALL, FLOOR, WALL ; 07
	...
	tilecoll WALL, WALL, RADIO, TV ; 1e
	...
	tilecoll COUNTER, COUNTER, FLOOR, COUNTER ; 34
	tilecoll FLOOR, COUNTER, FLOOR, COUNTER ; 35
	tilecoll WALL, FLOOR, UP_WALL, FLOOR ; 36
