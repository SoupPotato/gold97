...
INCLUDE "data/pokemon/base_stats/petamole.asm"
...
INCLUDE "data/pokemon/base_stats/tuhead.asm"
...
INCLUDE "data/pokemon/base_stats/ballerine.asm"
...
INCLUDE "data/pokemon/base_stats/elebabe.asm"
