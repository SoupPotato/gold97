...
Intro_InitSineLYOverrides:
	...
	ld a, wLYOverridesBackupEnd - wLYOverridesBackup
...
Intro_WaterGFX1:
INCBIN "gfx/intro/gs/water1.2bpp.lz"

Intro_WaterTilemap:
INCBIN "gfx/intro/gs/water.tilemap"

Intro_WaterMeta:
INCBIN "gfx/intro/gs/water.bin"

Intro_WaterGFX2:
INCBIN "gfx/intro/gs/water2.2bpp.lz"

Intro_GrassGFX1:
INCBIN "gfx/intro/gs/grass1.2bpp.lz"

Intro_GrassTilemap:
INCBIN "gfx/intro/gs/grass.tilemap"

Intro_GrassMeta:
INCBIN "gfx/intro/gs/grass.bin"

Intro_GrassGFX2:
INCBIN "gfx/intro/gs/grass2.2bpp.lz"

Intro_FireGFX1:
INCBIN "gfx/intro/gs/fire1.2bpp.lz"

Intro_FireGFX2:
INCBIN "gfx/intro/gs/fire2.2bpp.lz"

Intro_FireGFX3:
INCBIN "gfx/intro/gs/fire3.2bpp.lz"
