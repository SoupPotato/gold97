...
.do_turn
	...
	ld a, [wLastPlayerMon]
	ld [wCurBattleMon], a
	call PlayerMonFaintHappinessMod ; using old label for this function because lvl3's repo is older pokecrystal than what the wiki tutorial gives for this
	pop af
	ld [wCurBattleMon], a
	call PlayerMonFaintedAnimation
	ld hl, BattleText_MonFainted
...
;checkswarm
	...
	jr z, .check_alternate_swarm
	farcall GenerateSwarmShiny
	jr .next

.check_alternate_swarm
	ld hl, wSwarmFlags
