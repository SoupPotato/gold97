...
HoOhFrontpic:        INCBIN "gfx/pokemon/ho_oh/front_S.animated.2bpp.lz"
MachampFrontpic:     INCBIN "gfx/pokemon/machamp/front_S.animated.2bpp.lz"
NinetalesFrontpic:   INCBIN "gfx/pokemon/ninetales/front_S.animated.2bpp.lz"
AquariusFrontpic:    INCBIN "gfx/pokemon/aquarius/front_S.animated.2bpp.lz"
NidokingFrontpic:    INCBIN "gfx/pokemon/nidoking/front_S.animated.2bpp.lz"
RaikouFrontpic:      INCBIN "gfx/pokemon/raikou/front.animated.2bpp.lz"
BlisseyFrontpic:     INCBIN "gfx/pokemon/blissey/front_S.animated.2bpp.lz"
ArticunoFrontpic:    INCBIN "gfx/pokemon/articuno/front_S.animated.2bpp.lz"
TaurosFrontpic:      INCBIN "gfx/pokemon/tauros/front_S.animated.2bpp.lz"
...
BlastoiseFrontpic:   INCBIN "gfx/pokemon/blastoise/front_S.animated.2bpp.lz"
RapidashFrontpic:    INCBIN "gfx/pokemon/rapidash/front_S.animated.2bpp.lz"
MeganiumFrontpic:    INCBIN "gfx/pokemon/meganium/front_S.animated.2bpp.lz"
NidoqueenFrontpic:   INCBIN "gfx/pokemon/nidoqueen/front_S.animated.2bpp.lz"
HitmonleeFrontpic:   INCBIN "gfx/pokemon/hitmonlee/front_S.animated.2bpp.lz"
ScizorFrontpic:      INCBIN "gfx/pokemon/scizor/front_S.animated.2bpp.lz"
BeedrillFrontpic:    INCBIN "gfx/pokemon/beedrill/front_S.animated.2bpp.lz"
ArcanineFrontpic:    INCBIN "gfx/pokemon/arcanine/front_S.animated.2bpp.lz"
LickilordFrontpic:   INCBIN "gfx/pokemon/lickilord/front_S.animated.2bpp.lz"
MoltresFrontpic:     INCBIN "gfx/pokemon/moltres/front_S.animated.2bpp.lz"
ZapdosFrontpic:      INCBIN "gfx/pokemon/zapdos/front_S.animated.2bpp.lz"
ArbokFrontpic:       INCBIN "gfx/pokemon/arbok/front_S.animated.2bpp.lz"
MewtwoFrontpic:      INCBIN "gfx/pokemon/mewtwo/front_S.animated.2bpp.lz"
FearowFrontpic:      INCBIN "gfx/pokemon/fearow/front_S.animated.2bpp.lz"
CharizardFrontpic:   INCBIN "gfx/pokemon/charizard/front_S.animated.2bpp.lz"
VolbearFrontpic:     INCBIN "gfx/pokemon/volbear/front_S.animated.2bpp.lz"


SECTION "Pics 3", ROMX

SteelixFrontpic:     INCBIN "gfx/pokemon/steelix/front_S.animated.2bpp.lz"
AlakazamFrontpic:    INCBIN "gfx/pokemon/alakazam/front_S.animated.2bpp.lz"
GyaradosFrontpic:    INCBIN "gfx/pokemon/gyarados/front_S.animated.2bpp.lz"
KangaskhanFrontpic:  INCBIN "gfx/pokemon/kangaskhan/front_S.animated.2bpp.lz"
RhydonFrontpic:      INCBIN "gfx/pokemon/rhydon/front_S.animated.2bpp.lz"
GolduckFrontpic:     INCBIN "gfx/pokemon/golduck/front_S.animated.2bpp.lz"
RhyhornFrontpic:     INCBIN "gfx/pokemon/rhyhorn/front_S.animated.2bpp.lz"
PidgeotFrontpic:     INCBIN "gfx/pokemon/pidgeot/front_S.animated.2bpp.lz"
SlowbroFrontpic:     INCBIN "gfx/pokemon/slowbro/front_S.animated.2bpp.lz"
ButterfreeFrontpic:  INCBIN "gfx/pokemon/butterfree/front_S.animated.2bpp.lz"
WeezingFrontpic:     INCBIN "gfx/pokemon/weezing/front_S.animated.2bpp.lz"
CloysterFrontpic:    INCBIN "gfx/pokemon/cloyster/front_S.animated.2bpp.lz"
SkarmoryFrontpic:    INCBIN "gfx/pokemon/skarmory/front_S.animated.2bpp.lz"
DewgongFrontpic:     INCBIN "gfx/pokemon/dewgong/front_S.animated.2bpp.lz"
VictreebelFrontpic:  INCBIN "gfx/pokemon/victreebel/front_S.animated.2bpp.lz"
RaichuFrontpic:      INCBIN "gfx/pokemon/raichu/front_S.animated.2bpp.lz"
PrimeapeFrontpic:    INCBIN "gfx/pokemon/primeape/front_S.animated.2bpp.lz"
OmastarBackpic:      INCBIN "gfx/pokemon/omastar/back.2bpp.lz"


SECTION "Pics 4", ROMX

DodrioFrontpic:      INCBIN "gfx/pokemon/dodrio/front_S.animated.2bpp.lz"
SlowkingFrontpic:    INCBIN "gfx/pokemon/slowking/front_S.animated.2bpp.lz"
HitmontopFrontpic:   INCBIN "gfx/pokemon/hitmontop/front_S.animated.2bpp.lz"
OnixFrontpic:        INCBIN "gfx/pokemon/onix/front_S.animated.2bpp.lz"
MiltankFrontpic:     INCBIN "gfx/pokemon/miltank/front_S.animated.2bpp.lz"
MachokeFrontpic:     INCBIN "gfx/pokemon/machoke/front_S.animated.2bpp.lz"
DragoniteFrontpic:   INCBIN "gfx/pokemon/dragonite/front_S.animated.2bpp.lz"
PoliwrathFrontpic:   INCBIN "gfx/pokemon/poliwrath/front_S.animated.2bpp.lz"
ScytherFrontpic:     INCBIN "gfx/pokemon/scyther/front_S.animated.2bpp.lz"
...
JolteonFrontpic:     INCBIN "gfx/pokemon/jolteon/front_S.animated.2bpp.lz"
DonphanFrontpic:     INCBIN "gfx/pokemon/donphan/front_S.animated.2bpp.lz"
PinsirFrontpic:      INCBIN "gfx/pokemon/pinsir/front_S.animated.2bpp.lz"
UnownEFrontpic:      INCBIN "gfx/pokemon/unown_e/front.animated.2bpp.lz"


SECTION "Pics 5", ROMX

GolbatFrontpic:      INCBIN "gfx/pokemon/golbat/front_S.animated.2bpp.lz"
KinglerFrontpic:     INCBIN "gfx/pokemon/kingler/front_S.animated.2bpp.lz"
ExeggcuteFrontpic:   INCBIN "gfx/pokemon/exeggcute/front_S.animated.2bpp.lz"
MadameFrontpic:      INCBIN "gfx/pokemon/madame/front_S.animated.2bpp.lz"
PersianFrontpic:     INCBIN "gfx/pokemon/persian/front_S.animated.2bpp.lz"
BallerineFrontpic:   INCBIN "gfx/pokemon/ballerine/front_S.animated.2bpp.lz"
RaticateFrontpic:    INCBIN "gfx/pokemon/raticate/front_S.animated.2bpp.lz"
VenomothFrontpic:    INCBIN "gfx/pokemon/venomoth/front_S.animated.2bpp.lz"
PolitoedFrontpic:    INCBIN "gfx/pokemon/politoed/front_S.animated.2bpp.lz"
ElectabuzzFrontpic:  INCBIN "gfx/pokemon/electabuzz/front_S.animated.2bpp.lz"
RayleepFrontpic:     INCBIN "gfx/pokemon/rayleep/front_S.animated.2bpp.lz"
LickitungFrontpic:   INCBIN "gfx/pokemon/lickitung/front_S.animated.2bpp.lz"
KingdraFrontpic:     INCBIN "gfx/pokemon/kingdra/front_S.animated.2bpp.lz"
CharmeleonFrontpic:  INCBIN "gfx/pokemon/charmeleon/front_S.animated.2bpp.lz"
KadabraFrontpic:     INCBIN "gfx/pokemon/kadabra/front_S.animated.2bpp.lz"
ExeggutorFrontpic:   INCBIN "gfx/pokemon/exeggutor/front_S.animated.2bpp.lz"
GastlyFrontpic:      INCBIN "gfx/pokemon/gastly/front_S.animated.2bpp.lz"
BomshealFrontpic:    INCBIN "gfx/pokemon/bomsheal/front_S.animated.2bpp.lz"
ParasectFrontpic:    INCBIN "gfx/pokemon/parasect/front_S.animated.2bpp.lz"
MrMimeFrontpic:      INCBIN "gfx/pokemon/mr__mime/front_S.animated.2bpp.lz"
BellrunFrontpic:     INCBIN "gfx/pokemon/bellrun/front_S.animated.2bpp.lz"
...
PoliwhirlFrontpic:   INCBIN "gfx/pokemon/poliwhirl/front_S.animated.2bpp.lz"
NumbpuffFrontpic:    INCBIN "gfx/pokemon/numbpuff/front_S.animated.2bpp.lz"
HoundoomFrontpic:    INCBIN "gfx/pokemon/houndoom/front_S.animated.2bpp.lz"
KabutopsFrontpic:    INCBIN "gfx/pokemon/kabutops/front_S.animated.2bpp.lz"
AmpharosFrontpic:    INCBIN "gfx/pokemon/ampharos/front_S.animated.2bpp.lz"
NidorinaFrontpic:    INCBIN "gfx/pokemon/nidorina/front_S.animated.2bpp.lz"
FlareonFrontpic:     INCBIN "gfx/pokemon/flareon/front_S.animated.2bpp.lz"
FarfetchDFrontpic:   INCBIN "gfx/pokemon/farfetch_d/front_S.animated.2bpp.lz"
VileplumeFrontpic:   INCBIN "gfx/pokemon/vileplume/front_S.animated.2bpp.lz"
PetamoleFrontpic:    INCBIN "gfx/pokemon/petamole/front_S.animated.2bpp.lz"
MagmarFrontpic:      INCBIN "gfx/pokemon/magmar/front_S.animated.2bpp.lz"
TentacruelFrontpic:  INCBIN "gfx/pokemon/tentacruel/front_S.animated.2bpp.lz"
ElebabeFrontpic:     INCBIN "gfx/pokemon/elebabe/front_S.animated.2bpp.lz"
JumpluffFrontpic:    INCBIN "gfx/pokemon/jumpluff/front_S.animated.2bpp.lz"
...
VaporeonFrontpic:    INCBIN "gfx/pokemon/vaporeon/front_S.animated.2bpp.lz"
GirafarigFrontpic:   INCBIN "gfx/pokemon/girafarig/front_S.animated.2bpp.lz"
DrowzeeFrontpic:     INCBIN "gfx/pokemon/drowzee/front_S.animated.2bpp.lz"
SneaselFrontpic:     INCBIN "gfx/pokemon/sneasel/front_S.animated.2bpp.lz"
BellossomFrontpic:   INCBIN "gfx/pokemon/bellossom/front_S.animated.2bpp.lz"
SnorlaxFrontpic:     INCBIN "gfx/pokemon/snorlax/front_S.animated.2bpp.lz"
WigglytuffFrontpic:  INCBIN "gfx/pokemon/wigglytuff/front_S.animated.2bpp.lz"
CorasunFrontpic:     INCBIN "gfx/pokemon/corasun/front_S.animated.2bpp.lz"
SmeargleFrontpic:    INCBIN "gfx/pokemon/smeargle/front_S.animated.2bpp.lz"
ClefableFrontpic:    INCBIN "gfx/pokemon/clefable/front_S.animated.2bpp.lz"
PonytaFrontpic:      INCBIN "gfx/pokemon/ponyta/front_S.animated.2bpp.lz"
MurkrowFrontpic:     INCBIN "gfx/pokemon/murkrow/front_S.animated.2bpp.lz"
GravelerFrontpic:    INCBIN "gfx/pokemon/graveler/front_S.animated.2bpp.lz"
StarmieFrontpic:     INCBIN "gfx/pokemon/starmie/front_S.animated.2bpp.lz"
PidgeottoFrontpic:   INCBIN "gfx/pokemon/pidgeotto/front_S.animated.2bpp.lz"
LedybaFrontpic:      INCBIN "gfx/pokemon/ledyba/front_S.animated.2bpp.lz"
GengarFrontpic:      INCBIN "gfx/pokemon/gengar/front_S.animated.2bpp.lz"
OmastarFrontpic:     INCBIN "gfx/pokemon/omastar/front_S.animated.2bpp.lz"
PangshiFrontpic:     INCBIN "gfx/pokemon/pangshi/front_S.animated.2bpp.lz"
DugtrioFrontpic:     INCBIN "gfx/pokemon/dugtrio/front_S.animated.2bpp.lz"
MagnetonFrontpic:    INCBIN "gfx/pokemon/magneton/front_S.animated.2bpp.lz"
DragonairFrontpic:   INCBIN "gfx/pokemon/dragonair/front_S.animated.2bpp.lz"
GrimbyFrontpic:      INCBIN "gfx/pokemon/grimby/front_S.animated.2bpp.lz"
PeticornFrontpic:    INCBIN "gfx/pokemon/peticorn/front_S.animated.2bpp.lz"
KangaskhanBackpic:   INCBIN "gfx/pokemon/kangaskhan/back.2bpp.lz"


SECTION "Pics 8", ROMX

SeelFrontpic:        INCBIN "gfx/pokemon/seel/front_S.animated.2bpp.lz"
CrobatFrontpic:      INCBIN "gfx/pokemon/crobat/front_S.animated.2bpp.lz"
ChanseyFrontpic:     INCBIN "gfx/pokemon/chansey/front_S.animated.2bpp.lz"
TangelaFrontpic:     INCBIN "gfx/pokemon/tangela/front_S.animated.2bpp.lz"
SnubbullFrontpic:    INCBIN "gfx/pokemon/snubbull/front_S.animated.2bpp.lz"
QuagsireFrontpic:    INCBIN "gfx/pokemon/quagsire/front_S.animated.2bpp.lz"
ChixFrontpic:        INCBIN "gfx/pokemon/chix/front_S.animated.2bpp.lz"
HaunterFrontpic:     INCBIN "gfx/pokemon/haunter/front_S.animated.2bpp.lz"
SunfloraFrontpic:    INCBIN "gfx/pokemon/sunflora/front_S.animated.2bpp.lz"
UmbreonFrontpic:     INCBIN "gfx/pokemon/umbreon/front_S.animated.2bpp.lz"
ChikoritaFrontpic:   INCBIN "gfx/pokemon/chikorita/front_S.animated.2bpp.lz"
GoldeenFrontpic:     INCBIN "gfx/pokemon/goldeen/front_S.animated.2bpp.lz"
EspeonFrontpic:      INCBIN "gfx/pokemon/espeon/front_S.animated.2bpp.lz"
XatuFrontpic:        INCBIN "gfx/pokemon/xatu/front_S.animated.2bpp.lz"
MewFrontpic:         INCBIN "gfx/pokemon/mew/front_S.animated.2bpp.lz"
...
MagbyFrontpic:       INCBIN "gfx/pokemon/magby/front_S.animated.2bpp.lz"
WeepinbellFrontpic:  INCBIN "gfx/pokemon/weepinbell/front_S.animated.2bpp.lz"
CruizeFrontpic:      INCBIN "gfx/pokemon/cruize/front_S.animated.2bpp.lz"
PuddipupFrontpic:    INCBIN "gfx/pokemon/puddipup/front_S.animated.2bpp.lz"
FirebreatherPic:     INCBIN "gfx/trainers/firebreather.2bpp.lz"
MachopFrontpic:      INCBIN "gfx/pokemon/machop/front_S.animated.2bpp.lz"
KotoraFrontpic:      INCBIN "gfx/pokemon/kotora/front_S.animated.2bpp.lz"
RattataFrontpic:     INCBIN "gfx/pokemon/rattata/front_S.animated.2bpp.lz"
ChampionPic:         INCBIN "gfx/trainers/champion.2bpp.lz"
SpearowFrontpic:     INCBIN "gfx/pokemon/spearow/front_S.animated.2bpp.lz"
MagikarpFrontpic:    INCBIN "gfx/pokemon/magikarp/front_S.animated.2bpp.lz"
CharmanderFrontpic:  INCBIN "gfx/pokemon/charmander/front_S.animated.2bpp.lz"
CuboneFrontpic:      INCBIN "gfx/pokemon/cubone/front_S.animated.2bpp.lz"
BlackbeltTPic:       INCBIN "gfx/trainers/blackbelt_t.2bpp.lz"
BikerPic:            INCBIN "gfx/trainers/biker.2bpp.lz"
NidoranMFrontpic:    INCBIN "gfx/pokemon/nidoran_m/front_S.animated.2bpp.lz"
PorygonFrontpic:     INCBIN "gfx/pokemon/porygon/front_S.animated.2bpp.lz"
AgathaPic:           INCBIN "gfx/trainers/agatha.2bpp.lz"
GrimerFrontpic:      INCBIN "gfx/pokemon/grimer/front_S.animated.2bpp.lz"
StaryuFrontpic:      INCBIN "gfx/pokemon/staryu/front_S.animated.2bpp.lz"
HikerPic:            INCBIN "gfx/trainers/hiker.2bpp.lz"
MeowthFrontpic:      INCBIN "gfx/pokemon/meowth/front_S.animated.2bpp.lz"
Porygon2Frontpic:    INCBIN "gfx/pokemon/porygon2/front_S.animated.2bpp.lz"
SandshrewFrontpic:   INCBIN "gfx/pokemon/sandshrew/front_S.animated.2bpp.lz"
NidoranFFrontpic:    INCBIN "gfx/pokemon/nidoran_f/front_S.animated.2bpp.lz"
PidgeyFrontpic:      INCBIN "gfx/pokemon/pidgey/front_S.animated.2bpp.lz"
ParasectBackpic:     INCBIN "gfx/pokemon/parasect/back.2bpp.lz"


SECTION "Pics 10", ROMX

TritalesFrontpic:    INCBIN "gfx/pokemon/tritales/front_S.animated.2bpp.lz"
...
JigglypuffFrontpic:  INCBIN "gfx/pokemon/jigglypuff/front_S.animated.2bpp.lz"
ParasFrontpic:       INCBIN "gfx/pokemon/paras/front_S.animated.2bpp.lz"
...
PsyduckFrontpic:     INCBIN "gfx/pokemon/psyduck/front_S.animated.2bpp.lz"
SquirtleFrontpic:    INCBIN "gfx/pokemon/squirtle/front_S.animated.2bpp.lz"
MachampBackpic:      INCBIN "gfx/pokemon/machamp/back.2bpp.lz"
KoffingFrontpic:     INCBIN "gfx/pokemon/koffing/front_S.animated.2bpp.lz"
VenonatFrontpic:     INCBIN "gfx/pokemon/venonat/front_S.animated.2bpp.lz"
ExeggutorBackpic:    INCBIN "gfx/pokemon/exeggutor/back.2bpp.lz"
RaitoraFrontpic:     INCBIN "gfx/pokemon/raitora/front_S.animated.2bpp.lz"
TyrogueFrontpic:     INCBIN "gfx/pokemon/tyrogue/front_S.animated.2bpp.lz"
SkiploomFrontpic:    INCBIN "gfx/pokemon/skiploom/front_S.animated.2bpp.lz"
MareepFrontpic:      INCBIN "gfx/pokemon/mareep/front_S.animated.2bpp.lz"
OkeraPic:            INCBIN "gfx/trainers/okera.2bpp.lz"
EeveeFrontpic:       INCBIN "gfx/pokemon/eevee/front_S.animated.2bpp.lz"
ButterfreeBackpic:   INCBIN "gfx/pokemon/butterfree/back.2bpp.lz"
ZubatFrontpic:       INCBIN "gfx/pokemon/zubat/front_S.animated.2bpp.lz"
KimonoGirlPic:       INCBIN "gfx/trainers/kimono_girl.2bpp.lz"
AlakazamBackpic:     INCBIN "gfx/pokemon/alakazam/back.2bpp.lz"
AipomFrontpic:       INCBIN "gfx/pokemon/aipom/front_S.animated.2bpp.lz"
AbraFrontpic:        INCBIN "gfx/pokemon/abra/front_S.animated.2bpp.lz"
...
ClefairyFrontpic:    INCBIN "gfx/pokemon/clefairy/front_S.animated.2bpp.lz"
NyanyaFrontpic:      INCBIN "gfx/pokemon/nyanya/front_S.animated.2bpp.lz"
GrowlitheFrontpic:   INCBIN "gfx/pokemon/growlithe/front_S.animated.2bpp.lz"
SlowpokeFrontpic:    INCBIN "gfx/pokemon/slowpoke/front_S.animated.2bpp.lz"
SmoochumFrontpic:    INCBIN "gfx/pokemon/smoochum/front_S.animated.2bpp.lz"
JugglerPic:          INCBIN "gfx/trainers/juggler.2bpp.lz"
MarillFrontpic:      INCBIN "gfx/pokemon/marill/front_S.animated.2bpp.lz"
...
OmanyteFrontpic:     INCBIN "gfx/pokemon/omanyte/front_S.animated.2bpp.lz"
SkierPic:            INCBIN "gfx/trainers/skier.2bpp.lz"
WarwolfFrontpic:     INCBIN "gfx/pokemon/warwolf/front_S.animated.2bpp.lz"
BellsproutFrontpic:  INCBIN "gfx/pokemon/bellsprout/front_S.animated.2bpp.lz"
ShellderFrontpic:    INCBIN "gfx/pokemon/shellder/front_S.animated.2bpp.lz"
TentacoolFrontpic:   INCBIN "gfx/pokemon/tentacool/front_S.animated.2bpp.lz"
CleffaFrontpic:      INCBIN "gfx/pokemon/cleffa/front_S.animated.2bpp.lz"
...
DoduoFrontpic:       INCBIN "gfx/pokemon/doduo/front_S.animated.2bpp.lz"
AquariusBackpic:     INCBIN "gfx/pokemon/aquarius/back.2bpp.lz"
DratiniFrontpic:     INCBIN "gfx/pokemon/dratini/front_S.animated.2bpp.lz"
MagnetonBackpic:     INCBIN "gfx/pokemon/magneton/back.2bpp.lz"
PraxeFrontpic:       INCBIN "gfx/pokemon/praxe/front_S.animated.2bpp.lz"
SuicuneBackpic:      INCBIN "gfx/pokemon/suicune/back.2bpp.lz"
SlowkingBackpic:     INCBIN "gfx/pokemon/slowking/back.2bpp.lz"
ElebabeBackpic:      INCBIN "gfx/pokemon/elebabe/back.2bpp.lz"
...
PhanpyFrontpic:      INCBIN "gfx/pokemon/phanpy/front_S.animated.2bpp.lz"
RhydonBackpic:       INCBIN "gfx/pokemon/rhydon/back.2bpp.lz"
WolfanFrontpic:      INCBIN "gfx/pokemon/wolfan/front_S.animated.2bpp.lz"
...
OddishFrontpic:      INCBIN "gfx/pokemon/oddish/front_S.animated.2bpp.lz"
RapidashBackpic:     INCBIN "gfx/pokemon/rapidash/back.2bpp.lz"
DoduoBackpic:        INCBIN "gfx/pokemon/doduo/back.2bpp.lz"
HoppipFrontpic:      INCBIN "gfx/pokemon/hoppip/front_S.animated.2bpp.lz"
...
QwilfishFrontpic:    INCBIN "gfx/pokemon/qwilfish/front_S.animated.2bpp.lz"
...
BulbasaurFrontpic:   INCBIN "gfx/pokemon/bulbasaur/front_S.animated.2bpp.lz"
...
PichuFrontpic:       INCBIN "gfx/pokemon/pichu/front_S.animated.2bpp.lz"
ElectabuzzBackpic:   INCBIN "gfx/pokemon/electabuzz/back.2bpp.lz"
TripstarBackpic:     INCBIN "gfx/pokemon/tripstar/back.2bpp.lz"
...
RinringFrontpic:     INCBIN "gfx/pokemon/rinring/front_S.animated.2bpp.lz"
PonytaBackpic:       INCBIN "gfx/pokemon/ponyta/back.2bpp.lz"
RemoraidFrontpic:    INCBIN "gfx/pokemon/remoraid/front_S.animated.2bpp.lz"
PoliwagFrontpic:     INCBIN "gfx/pokemon/poliwag/front_S.animated.2bpp.lz"
...
GupgoldFrontpic:     INCBIN "gfx/pokemon/gupgold/front_S.animated.2bpp.lz"
...
GeodudeFrontpic:     INCBIN "gfx/pokemon/geodude/front_S.animated.2bpp.lz"
...
IgglybuffFrontpic:   INCBIN "gfx/pokemon/igglybuff/front_S.animated.2bpp.lz"
...
DiglettFrontpic:     INCBIN "gfx/pokemon/diglett/front_S.animated.2bpp.lz"
...
TuheadBackpic:       INCBIN "gfx/pokemon/tuhead/back.2bpp.lz"
...
HorseaFrontpic:      INCBIN "gfx/pokemon/horsea/front_S.animated.2bpp.lz"
...
KakunaFrontpic:      INCBIN "gfx/pokemon/kakuna/front_S.animated.2bpp.lz"
...
WeedleFrontpic:      INCBIN "gfx/pokemon/weedle/front_S.animated.2bpp.lz"
...
MagnemiteFrontpic:   INCBIN "gfx/pokemon/magnemite/front_S.animated.2bpp.lz"
...
TogepiFrontpic:      INCBIN "gfx/pokemon/togepi/front_S.animated.2bpp.lz"
...
MetapodFrontpic:     INCBIN "gfx/pokemon/metapod/front_S.animated.2bpp.lz"
...
CaterpieFrontpic:    INCBIN "gfx/pokemon/caterpie/front_S.animated.2bpp.lz"
...
KurstrawFrontpic:    INCBIN "gfx/pokemon/kurstraw/front_S.animated.2bpp.lz"
...
VoltorbFrontpic:     INCBIN "gfx/pokemon/voltorb/front_S.animated.2bpp.lz"
...
NatuFrontpic:        INCBIN "gfx/pokemon/natu/front_S.animated.2bpp.lz"
...
RayleepBackpic:      INCBIN "gfx/pokemon/rayleep/back.2bpp.lz"
