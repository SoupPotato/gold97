...
; 153-160 top halves
INCBIN "gfx/footprints/budleef.1bpp",    footprint_top
...
INCBIN "gfx/footprints/tang.1bpp",    footprint_bottom
...
INCBIN "gfx/footprints/twinborus.1bpp",  footprint_top
...
INCBIN "gfx/footprints/twinborus.1bpp",  footprint_bottom
