	...
	tilepal 0, BROWN, GREEN, BROWN, BROWN, BROWN, GRAY, GRAY, BROWN
	...
	tilepal 1, GRAY, GRAY, YELLOW, YELLOW, RED, RED, WATER, WATER
	tilepal 1, BROWN, BROWN, GRAY, GRAY, GRAY, GRAY, GRAY, GRAY
	tilepal 1, GRAY, GRAY, YELLOW, YELLOW, BROWN, BROWN, WATER, WATER
	tilepal 1, GRAY, GRAY, GRAY, GRAY, GREEN, GREEN, GREEN, GREEN
	tilepal 1, BROWN, BROWN, GRAY, YELLOW, RED, RED, YELLOW, WATER
