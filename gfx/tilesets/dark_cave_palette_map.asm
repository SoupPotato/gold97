	...
	tilepal 0, BROWN, BROWN, BROWN, BROWN, GRAY, GRAY, GRAY, GRAY
	tilepal 0, WATER, BROWN, WATER, WATER, BROWN, BROWN, WATER, WATER
	tilepal 0, WATER, WATER, BROWN, BROWN, BROWN, BROWN, GRAY, GRAY
	tilepal 0, WATER, WATER, GRAY, GRAY, BROWN, GRAY, GRAY, GRAY
	...
	tilepal 1, WATER, BROWN, WATER, WATER, GRAY, GRAY, GRAY, GRAY
	tilepal 1, GRAY, GRAY, GRAY, GRAY, GRAY, GRAY, GRAY, GRAY
