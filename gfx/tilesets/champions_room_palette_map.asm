	...
	tilepal 0, GRAY, GRAY, GRAY, GREEN, GREEN, YELLOW, GRAY, GRAY
	tilepal 0, GRAY, GRAY, GRAY, GRAY, GRAY, GRAY, GRAY, GRAY
	tilepal 0, GRAY, GRAY, GRAY, RED, RED, RED, GRAY, GRAY
	...
	tilepal 1, BROWN, BROWN, GRAY, GRAY, RED, WATER, WATER, WATER
