	tilepal 0, GRAY, RED, GRAY, WATER, WATER, WATER, WATER, WATER
	...
	tilepal 1, YELLOW, GREEN, GREEN, GRAY, GRAY, RED, RED, GRAY
	tilepal 1, RED, RED, RED, RED, RED, RED, WATER, GRAY
	tilepal 1, YELLOW, BROWN, BROWN, GRAY, GRAY, GRAY, GRAY, GRAY
