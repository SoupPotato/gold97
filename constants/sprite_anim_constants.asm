...
; SpriteAnimSeqData indexes (see data/sprite_anims/sequences.asm)
	...
	const SPRITE_ANIM_INDEX_GS_INTRO_FIREBALL
	const SPRITE_ANIM_INDEX_GS_INTRO_CRUIZE
	const SPRITE_ANIM_INDEX_GS_INTRO_FLAMBEAR
	const SPRITE_ANIM_INDEX_GS_INTRO_CHIKORITA
	const SPRITE_ANIM_INDEX_GS_INTRO_PIKACHU_TAIL
	const SPRITE_ANIM_INDEX_GS_INTRO_PIKACHU
	const SPRITE_ANIM_INDEX_GS_INTRO_JIGGLYPUFF
	const SPRITE_ANIM_INDEX_GS_INTRO_INVISIBLE_NOTE
	const SPRITE_ANIM_INDEX_GS_INTRO_NOTE
	const SPRITE_ANIM_INDEX_GS_INTRO_LAPRAS
	const SPRITE_ANIM_INDEX_GS_INTRO_SHELLDER
...
; DoAnimFrame.Jumptable indexes (see engine/gfx/sprite_anims.asm)
	...
	const SPRITE_ANIM_SEQ_GS_INTRO_FIREBALL
	const SPRITE_ANIM_SEQ_GS_INTRO_CHIKORITA_CRUIZE
	const SPRITE_ANIM_SEQ_GS_INTRO_FLAMBEAR
	const SPRITE_ANIM_SEQ_GS_INTRO_PIKACHU_TAIL
	const SPRITE_ANIM_SEQ_GS_INTRO_PIKACHU
	const SPRITE_ANIM_SEQ_GS_INTRO_JIGGLYPUFF
	const SPRITE_ANIM_SEQ_GS_INTRO_NOTE
	const SPRITE_ANIM_SEQ_GS_INTRO_LAPRAS
...
; SpriteAnimFrameData indexes (see data/sprite_anims/framesets.asm)
	...
	const SPRITE_ANIM_FRAMESET_GS_INTRO_FIREBALL
	const SPRITE_ANIM_FRAMESET_GS_INTRO_CRUIZE
	const SPRITE_ANIM_FRAMESET_GS_INTRO_FLAMBEAR
	const SPRITE_ANIM_FRAMESET_GS_INTRO_CHIKORITA
	const SPRITE_ANIM_FRAMESET_GS_INTRO_PIKACHU_TAIL
	const SPRITE_ANIM_FRAMESET_GS_INTRO_PIKACHU_TAIL_2
	const SPRITE_ANIM_FRAMESET_GS_INTRO_PIKACHU
	const SPRITE_ANIM_FRAMESET_GS_INTRO_PIKACHU_2
	const SPRITE_ANIM_FRAMESET_GS_INTRO_PIKACHU_3
	const SPRITE_ANIM_FRAMESET_GS_INTRO_PIKACHU_4
	const SPRITE_ANIM_FRAMESET_GS_INTRO_JIGGLYPUFF
	const SPRITE_ANIM_FRAMESET_GS_INTRO_JIGGLYPUFF_2
	const SPRITE_ANIM_FRAMESET_GS_INTRO_INVISIBLE_NOTE
	const SPRITE_ANIM_FRAMESET_GS_INTRO_NOTE
	const SPRITE_ANIM_FRAMESET_GS_INTRO_LAPRAS
	const SPRITE_ANIM_FRAMESET_GS_INTRO_SHELLDER
...
; SpriteAnimOAMData indexes (see data/sprite_anims/oam.asm)
	...
	const SPRITE_ANIM_OAMSET_GS_INTRO_CRUIZE            ; 1d
