...
; battle types (wBattleType values)
	...
	const BATTLETYPE_LEAFEON
	const BATTLETYPE_SUICUNE
	const BATTLETYPE_LEGENDKANTO
...
BATTLERESULT_CAUGHT_LEAFEON EQU 6
BATTLERESULT_BOX_FULL EQU 7
BATTLERESULT_BITMASK EQU (1 << BATTLERESULT_CAUGHT_LEAFEON) | (1 << BATTLERESULT_BOX_FULL)
