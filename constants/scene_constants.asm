...
; wElmEntranceSceneID
	...
	const SCENE_OAK_ENTRANCE_NOTHING
	const SCENE_OAK_ENTRANCE_BATTLE
	const SCENE_OAK_ENTRANCE_DAISY
	const SCENE_OAK_LAB_FRONT_ROOM_AFTER_TALKING_TO_CLERK

; wElmsLabSceneID
	const_def 1
	const SCENE_OAKSLAB_CANT_LEAVE            ; 1
	const SCENE_OAKSLAB_NOTHING               ; 2
	const SCENE_OAKSLAB_MEET_OFFICER          ; 3
	const SCENE_OAKSLAB_UNUSED                ; 4
	const SCENE_OAKSLAB_AIDE_GIVES_POTION     ; 5
	const SCENE_OAKSLAB_AIDE_GIVES_POKE_BALLS ; 6
...
; wRoute35NationalParkGateSceneID
	const_def
	const SCENE_NATIONALPARK_STANDCITY_GATE_NOTHING             ; 0
	const SCENE_NATIONALPARK_STANDCITY_GATE_UNUSED              ; 1
	const SCENE_NATIONALPARK_STANDCITY_GATE_LEAVE_CONTEST_EARLY ; 2
...
; wFastShip1FSceneID
	...
	const SCENE_FASTSHIP1F_CAPTAIN_ANNOUNCEMENT ; 2
