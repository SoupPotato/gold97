...
; Johto story events
	...
	const EVENT_03C
	const EVENT_03D
	const EVENT_GOT_TM13_SNORE_FROM_MOOMOO_FARM ; used on boardwalk
	const EVENT_03F
...
; Johto people
	...
	const EVENT_RIVAL_AZALEA_TOWN; entei event
	...
	const EVENT_MAHOGANY_TOWN_POKEFAN_M_BLOCKS_GYM ; this is used for the rockets in the aquarium
	...
	const EVENT_BURNED_TOWER_MORTY ; morty in the mines, actually whitney cause im dumb
...
; New to Crystal
	...
	const EVENT_ECRUTEAK_GYM_GRAMPS; used for grandpa at home
	const EVENT_ECRUTEAK_CITY_GRAMPS; used for grandpa at mine
