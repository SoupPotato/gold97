...
; Johto story events
	...
	const EVENT_JASMINE_EXPLAINED_AMPHYS_SICKNESS; used for the guy who gives you a mysteryberry in celadon cafe map
	...
	const EVENT_GOT_SHUCKIE; used for red appearing in the gym
...
; Extras for gold 97
	...
	const EVENT_VICTORY_ROAD_HIDDEN_MAX_POTION_NEW
	const EVENT_VICTORY_ROAD_HIDDEN_FULL_HEAL_NEW
	const EVENT_VICTORY_ROAD_TM_EARTHQUAKE_NEW
	const EVENT_VICTORY_ROAD_MAX_REVIVE_NEW
	const EVENT_VICTORY_ROAD_FULL_RESTORE_NEW
	const EVENT_VICTORY_ROAD_FULL_HEAL_NEW
	const EVENT_VICTORY_ROAD_HP_UP_NEW
	const EVENT_BEAT_KVR_TRAINER1
	const EVENT_BEAT_KVR_TRAINER2
	const EVENT_BEAT_KVR_TRAINER3
	const EVENT_BEAT_KVR_TRAINER4
	const EVENT_BEAT_KVR_TRAINER5
	const EVENT_BEAT_KVR_TRAINER6
	...
	const EVENT_BEAT_BLACKBELT_KENJIKKC
...
; Johto people
	...
	const EVENT_BLACKTHORN_CITY_GRAMPS_BLOCKS_DRAGONS_DEN; used, clair blocks cave of dragons
	const EVENT_BLACKTHORN_CITY_GRAMPS_NOT_BLOCKING_DRAGONS_DEN; used, for clair in her house
