...
; Johto story events
	...
	const EVENT_RECEIVED_NEW_FUELINE_FOR_SHIP
	...
	const EVENT_DEEPWATER_PASSAGE_PRYCE_GONE
	const EVENT_HIDE_FROSTPOINT_PRYCE
	...
	const EVENT_GOT_ODD_EGG_FROM_OAKS_AIDE
	const EVENT_MADE_UNOWN_APPEAR_IN_RUINS
	const EVENT_FAST_SHIP_DESTINATION_WESTPORT
	...
	const EVENT_KANTO_LEFTOVERS_HOUSE_GOT_LEFTOVERES
	const EVENT_KANTO_FISHING_GURU_EXPLAINED_WEIRD_MAGIKARP
	const EVENT_KANTO_FISHING_GURU_ASKED_FOR_MAGIKARP
	const EVENT_KANTO_FISHING_GURU_ELIXIR_ON_STANDBY
	const EVENT_ROUTE_115_ROCKS_DEMOLISHED
	const EVENT_03C
	const EVENT_03D
	const EVENT_GOT_TM35_FROM_SANSKRIT_GATE_OFFICER
	const EVENT_03F
	...
	const EVENT_KANTO_GYM_RED_GONE
	...
	const EVENT_GAVE_KENYA; used to make silver disappear in r36 ruins gate above stand city
	const EVENT_GOT_HP_UP_FROM_RANDY; makes rockets disappear in stand city not secret base
	...
	const EVENT_GOT_BLACKGLASSES_IN_AMPARE_CAVERN
...
; Johto hidden items
	...
	const EVENT_CHARRED_SUMMIT_HIDDEN_HYPER_POTION
	const EVENT_JOULE_CAVE_HIDDEN_MAX_REPEL
	...
	const EVENT_DRAGONS_MAW_HIDDEN_REVIVE
	const EVENT_DRAGONS_MAW_HIDDEN_MAX_POTION
	const EVENT_DRAGONS_MAW_HIDDEN_MAX_ELIXER
	const EVENT_ROUTE_28_HIDDEN_RARE_CANDY
	const EVENT_ROUTE_30_HIDDEN_HYPER_POTION
	...
	const EVENT_ROUTE_45_HIDDEN_PP_UP; victory road 2f tm toxic
...
; Crystal-exclusive events in Johto
	...
	const EVENT_0C7
; Kanto story events
	const EVENT_GOT_NUGGET_FROM_ENDON_CAVE_NUGGET_GUY
	...
	const EVENT_0CA
	const EVENT_0CB
	const EVENT_GOT_BATTLE_CLUB_PASS
	const EVENT_0CC
	const EVENT_0CD
	const EVENT_0CE
	const EVENT_0CF
	const EVENT_ENABLE_DIPLOMA_PRINTING
	const EVENT_TEKNOS_BRIDGE_REPAIRED
...
; Kanto hidden items
	...
	const EVENT_CROWN_PASS_HIDDEN_FULL_RESTORE
	const EVENT_CROWN_PASS_HIDDEN_X_SPECIAL
	const EVENT_BOULDER_MINES_B2F_HIDDEN_X_ACCURACY
	const EVENT_BOULDER_MINES_B2F_HIDDEN_X_DEFEND
	const EVENT_BOULDER_MINES_B3F_HIDDEN_MAX_POTION
	const EVENT_OLIVINE_PORT_HIDDEN_PROTEIN
	const EVENT_AMAMI_PORT_HIDDEN_IRON
	const EVENT_MOUNT_MOON_SQUARE_HIDDEN_MOON_STONE ; this is used now - cam
	...
	const EVENT_0D4
	const EVENT_0D5
	const EVENT_MERIDIAN_PATH_HIDDEN_MAX_POTION
	const EVENT_FOUND_MYSTERY_BERRY_IN_CELADON_CAFE
	const EVENT_FOUND_BERSERK_GENE_IN_NAGO_VILLAGE
	const EVENT_GOT_DRAGON_ORB_IN_DRAGONS_MAW
...
; Extras for gold 97
	...
	const EVENT_TALKED_TO_KURT_AND_FALKNER
	const EVENT_FALKNER_AT_GYM
	const EVENT_ROUTE36_TREE_CHOPPED
	const EVENT_ROUTE36_GARDENER
	const EVENT_ROUTE36_GARDENER_CHOPPED
	const EVENT_BEAT_TEKU_CITY_GRUNT1
	const EVENT_BEAT_TEKU_CITY_GRUNT2
	const EVENT_TEKNOS_GRAMPA_LITTLE_GIRL_SAVED
	const EVENT_LITTLE_GIRL_AT_BOULDER_MINES_ENTRANCE
	const EVENT_ECRUTEAK_SCARED_LASS
	const EVENT_WHITNEY_BACK_IN_GYM
	const WHITNEY_FIGHTING_ROCKETS
	const EVENT_AQUARIUM_ROCKETS_IDLE
	const WHITNEY_DEFEATS_ROCKETS
	const EVENT_ROUTE_29_POKEBALL
	const EVENT_ROUTE_29_ETHER
	const EVENT_ROUTE_36_GREATBALL
	const EVENT_ROUTE_35_SUPER_POTION
	const EVENT_ROUTE_8_PARLYZ_HEAL
	const EVENT_SOUTH_POINT_HIDDEN_WATER_STONE
	const EVENT_HONDO_ROCKET_RUNS_AWAY
	const EVENT_HONDO_ROCKET_SHIP_KEY
	const EVENT_ROUTE_30_POISON_STONE
	const EVENT_OKERA_AT_BASE
	const EVENT_IMPOSTER_FIGHTING_OKERA
	const EVENT_IMPOSTER_FIGHTING_OKERA_2
	const EVENT_ROCKET_MACHINE_DAMAGED
	const EVENT_DIGLETTS_CAVE_HIDDEN_MAX_REVIVE
	const EVENT_ROCK_TUNNEL_1F_HIDDEN_X_ACCURACY_NEW
	const EVENT_ROCK_TUNNEL_1F_HIDDEN_X_DEFEND_NEW
	const EVENT_ROCK_TUNNEL_1F_ELIXER_NEW
	const EVENT_ROCK_TUNNEL_1F_TM_STEEL_WING_NEW
	const EVENT_ROCK_TUNNEL_B1F_HIDDEN_MAX_POTION_NEW
	const EVENT_ROCK_TUNNEL_B1F_IRON_NEW
	const EVENT_ROCK_TUNNEL_B1F_PP_UP_NEW
	const EVENT_ROCK_TUNNEL_B1F_REVIVE_NEW
	const EVENT_KANTO_VICTORY_ROAD_HIDDEN_MAX_POTION
	const EVENT_KANTO_VICTORY_ROAD_HIDDEN_FULL_HEAL
	const EVENT_KANTO_VICTORY_ROAD_TM_EARTHQUAKE
	const EVENT_KANTO_VICTORY_ROAD_MAX_REVIVE
	const EVENT_KANTO_VICTORY_ROAD_FULL_RESTORE
	const EVENT_KANTO_VICTORY_ROAD_FULL_HEAL
	const EVENT_KANTO_VICTORY_ROAD_HP_UP
	const EVENT_BEAT_KANTO_VICTORY_ROAD_TRAINER1
	const EVENT_BEAT_KANTO_VICTORY_ROAD_TRAINER2
	const EVENT_BEAT_KANTO_VICTORY_ROAD_TRAINER3
	const EVENT_BEAT_KANTO_VICTORY_ROAD_TRAINER4
	const EVENT_BEAT_KANTO_VICTORY_ROAD_TRAINER5
	const EVENT_BEAT_KANTO_VICTORY_ROAD_TRAINER6
	const EVENT_BEAT_KR_TRAINER1
	const EVENT_BEAT_KR_TRAINER2
	const EVENT_BEAT_KR_TRAINER3
	const EVENT_BEAT_KR_TRAINER4
	const EVENT_PICKED_UP_OLD_AMBER
	const EVENT_KANTO_DOCK_STARPIECE
	const EVENT_BEAT_KDOCKS_TRAINER1
	const EVENT_BEAT_KDOCKS_TRAINER2
	const EVENT_BEAT_KDOCKS_TRAINER3
	const EVENT_SAFARI_ITEMBALL
	const EVENT_WON_SURGE_BATTLE
	const EVENT_TOOK_THE_PICHU
	const EVENT_PP_VOLTORB1
	const EVENT_PP_VOLTORB2
	const EVENT_PP_VOLTORB3
	const EVENT_PP_VOLTORB4
	const EVENT_PP_VOLTORB5
	const EVENT_PP_VOLTORB6
	const EVENT_PP_VOLTORB7
	const EVENT_PP_VOLTORB8
	const EVENT_PP_ITEM1
	const EVENT_PP_ITEM2
	const EVENT_PP_ITEM3
	const EVENT_PP_ITEM4
	const EVENT_BEAT_TOWER_GENGAR
	const EVENT_BEAT_SAGE_WANG
	const EVENT_TOWER3_ITEMBALL
	const EVENT_BEAT_MEDIUM_MURIEL
	const EVENT_BEAT_MEDIUM_ESTHER
	const EVENT_TOWER2_ITEMBALL
	const EVENT_GIVEN_BALL_FROM_AIDE
	const EVENT_SEAFOAM_ITEM_1
	const EVENT_SEAFOAM_ITEM_2
	const EVENT_SEAFOAM_ITEM_3
	const EVENT_SEAFOAM_ITEM_4
	const EVENT_BATTLE_TOWER_OUTSIDE_SAILOR_NEW
	const EVENT_BEAT_FORKED_STRAIT_STIRNER
	const EVENT_BEAT_FORKED_STRAIT_EDGAR
	const EVENT_FORKED_STRAIT_LURE_BALL
	const EVENT_DONE_FORKED_STRAIT_GATE_CHECK
	const EVENT_MEW_SPOT_1_FOUND
	const EVENT_MEW_SPOT_2_FOUND
	...
	const EVENT_RAINBOW_ISLE_CAVE_OBJECTS_HIDDEN
	const EVENT_RAINBOW_ISLE_BLUE_BATTLE_HIDDEN
	const EVENT_RAINBOW_ISLE_CAVE_BLUE_HIDDEN
	const EVENT_RAINBOW_ISLE_BLUE_INTRO_HIDDEN
	const EVENT_RAINBOW_ISLE_CAVE_BLUE_TOLD_LEGEND
	const EVENT_RAINBOW_ISLE_RESTORED
	const EVENT_BEAT_BLUE_ONCE_BEFORE
	...
	const EVENT_BATTLE_AVAILABLE_CLAIR
	const EVENT_GOT_EXTRA_THIEF_TM
	const EVENT_GOLD_TROPHY_IN_PACKAGE
	const EVENT_SILVER_TROPHY_IN_PACKAGE
	const EVENT_PACKAGE_TAKEN_NO_SHOW
	const EVENT_TAKEN_SILVER_TROPHY
	const EVENT_TAKEN_GOLD_TROPHY
	const EVENT_KIKAI_SUMMIT_FIRE_TAIL
	const EVENT_BRUNO_SMASHED_ROCK
	const EVENT_KIKAI_SUMMIT_OTHER_ROCK
	const EVENT_KIKAI_BRUNO_DEFEATED
	const EVENT_BEAT_BLACKBELT_IZO
	const EVENT_BEAT_BLACKBELT_KENJI_KIKAI_CALDERA
	const EVENT_BEAT_BLACKBELT_TARO
	const EVENT_KIKAI_CALDERA_1F_PROTEIN
	const EVENT_KIKAI_CALDERA_1F_FIRE_STONE
	const EVENT_BEAT_BLACKBELT_OKUMA
	const EVENT_KIKAI_CALDERA_2F_FOCUS_ORB
	const EVENT_TATSUGO_PATH_ITEMBALL
	const EVENT_BEAT_SUPERNERD_NORTON
	const EVENT_BEAT_INSTRUCTOR_MOSHE
	const EVENT_BEAT_TEACHER_HOLLY
	const EVENT_GREAT_EAST_STRAIT_NUGGET
	...
	const EVENT_DANCE_HALL_ROCKETS_ESCAPED
	const EVENT_BEAT_CM_ROCKET_EXECUTIVE
	const EVENT_ACTIVATED_LEFT_CM_TRAPDOOR
	const EVENT_ACTIVATED_RIGHT_CM_TRAPDOOR
	const EVENT_ACTIVATED_TOP_CM_TRAPDOOR
	const EVENT_CASTLE_B1F_SPRITES_NOT_SHOWN
	const EVENT_CASTLE_DRAGONITE_NOT_SHOWN
	const EVENT_CASTLE_MTN_EVENTS_COMPLETE
	const EVENT_UNBLOCK_STAIRS_ROOM
	const EVENT_CM_CAVE_ITEMBALL
	const EVENT_CM_DANCEHALL_ITEMBALL
	const EVENT_CM_LONGHALL_ITEMBALL1
	const EVENT_CM_LONGHALL_ITEMBALL2
	const EVENT_CM_2F_ITEMBALL1
	const EVENT_CM_2F_ITEMBALL2
	const EVENT_CM3A_NUGGET1
	const EVENT_CM3A_NUGGET2
	const EVENT_CM3A_NUGGET3
	const EVENT_CM3A_NUGGET4
	const EVENT_CM3A_NUGGET5
	const EVENT_CM3A_NUGGET6
	const EVENT_CM3A_NUGGET7
	const EVENT_CM3A_NUGGET8
	const EVENT_CM3B_ITEMBALL1
	const EVENT_CM3B_ITEMBALL2
	const EVENT_CMB1_ITEMBALL1
	const EVENT_CMB1_ITEMBALL2
	...
	const EVENT_DESERTER_ROCKET_GRUNT
	...
	const EVENT_BEAT_ROCKET_GRUNTF_16
	const EVENT_BEAT_ROCKET_GRUNTM_40
	const EVENT_BEAT_ROCKET_GRUNTM_41
	const EVENT_TOOK_DINING_HALL_LEFTOVERS
	const EVENT_CM_HIDDENITEM1
	const EVENT_CM_HIDDENITEM2
	const EVENT_CM_HIDDENITEM3
	const EVENT_CM_HIDDENITEM4
	const EVENT_CM_HIDDENITEM5
	const EVENT_CM_HIDDENITEM6
	const EVENT_CM_HIDDENITEM7
	const EVENT_CM_HIDDENITEM8
	const EVENT_CM_HIDDENITEM9
	const EVENT_CM_HIDDENITEM10
	const EVENT_CM_HIDDENITEM11
	const EVENT_CM_HIDDENITEM12
	const EVENT_BRASS_TOWER_BLESSING_QUEST_COMPLETE
	...
	const EVENT_TIDAL_GROTTO_B1F_MAX_REVIVE
	const EVENT_TIDAL_GROTTO_B1F_ULTRA_BALL
	const EVENT_TIDAL_GROTTO_B1F_RARE_CANDY
	const EVENT_TIDAL_GROTTO_B1F_WATER_STONE
	const EVENT_BEAT_SWIMMERF_HIKARI
	const EVENT_ROUTE_101_RARE_CANDY
	const EVENT_BOARDWALK_AMULET_COIN
	const EVENT_BIRDON_AIDE_HIDDEN
	const EVENT_GOT_HOTEL_PASS
	const EVENT_HOTEL_UPSTAIRS_IS_BLOCKED
	const EVENT_HOTEL_UPSTAIRS_IS_NOT_BLOCKED
	const EVENT_BATTLED_OAK
	const EVENT_OAK_HERE_ON_WEEKENDS
	const EVENT_BEAT_KIMONO_GIRL_KYOKO
	const EVENT_GOT_COINS_FROM_GENTLEMAN
	const EVENT_TALKED_TO_COINS_GUY
	const EVENT_BEAT_PSYCHIC_T_RAPHAEL
	const EVENT_BEAT_COOLTRAINERF_AYANO
	const EVENT_BEAT_COOLTRAINERF_YUKA
	const EVENT_BEAT_COOLTRAINERF_AYAKA
	const EVENT_BEAT_COOLTRAINERM_WOZNIAK
	const EVENT_BEAT_LASS_ELIZA
	const EVENT_RYUKYU_HOTEL_HIDDEN_MAX_POTION
	const EVENT_1F9
	const EVENT_1FA
	const EVENT_1FB
	const EVENT_1FC
...
; Decorations
	...
	const EVENT_DECO_BUTTERFREE_DOLL
...
; More Johto story events
	...
	const EVENT_BATTLE_CLUB_SUNDAY; sunday
	const EVENT_BATTLE_CLUB_MONDAY; monday
	const EVENT_BATTLE_CLUB_TUESDAY; tueaday
	const EVENT_EMERGENCY_SWITCH; used, makes rival disappear in princely path / underground
	const EVENT_BATTLE_CLUB_WEDNESDAY; wednesday
	const EVENT_BATTLE_CLUB_THURSDAY; thursday
	const EVENT_BATTLE_CLUB_FRIDAY; friday
	const EVENT_BATTLE_CLUB_SATURDAY; saturday
	const EVENT_2DB
	const EVENT_SWITCH_9; used after talking to heal lass on mt fuji for the first time
	const EVENT_GOT_SCOPE_LENS_IN_CROWN_CITY; scope lens from granny in prince city
	...
	const EVENT_ABRA_TELEPORT_GUY_AMAMI
	const EVENT_ABRA_TELEPORT_GUY_WESTPORT
	const EVENT_FOUGHT_ZAPDOS
	const EVENT_FOUGHT_MOLTRES
	const EVENT_2ED
	const EVENT_NAGO_VILLAGE_RECEIVED_CHARMANDER
	const EVENT_HIDE_CHARRED_SUMMIT_MOLTRES
	const EVENT_HIDE_JOULE_CAVE_ZAPDOS_ROOM_ZAPDOS
	const EVENT_FOUGHT_ARTICUNO
	const EVENT_HIDE_ICED_CAVERN_B1F_ARTICUNO
	const EVENT_TRI_WING_YOUNGSTER_SETUP
	const EVENT_RECEIVED_TRI_WING_FROM_YOUNGSTER
	const EVENT_AMAMI_SWIMMING_POOL_GOT_SQUIRTLE
	const EVENT_EXPLODING_TRAP_14; used for getting bulbasaur in ryukyu city
	const EVENT_2F7
	const EVENT_NANJO_FOREST_RIVAL_DEFEATED
	...
	const EVENT_KANTO_N64_ROCKER_AT_GAME_CORNER
	const EVENT_KANTO_ROCKER_AT_N64_HOUSE
	const EVENT_KUME_N64_LASS_AT_SOCIAL_HOUSE
	const EVENT_KUME_LASS_AT_N64_HOUSE
	...
	const EVENT_GIOVANNIS_ROOM_ENTRANCE_CLOSED
	const EVENT_GIOVANNIS_ROOM_EXIT_OPEN ; 310
	...
	const EVENT_MET_EARL
	const EVENT_SHOWED_FARFETCHD_TO_EARL
	const EVENT_SHOWED_DRATINI_TO_EARL
	...
	const EVENT_BIRDON_N64_YOUNGSTER_LEFT_CAFE
	const EVENT_BIRDON_YOUNGSTER_AT_N64_HOUSE
	const EVENT_N64_HOUSE_LOOKING_FOR_PLAYERS
...
; More Crystal-exclusive events in Johto
	...
	const EVENT_GOT_SECOND_ODD_EGG_AT_DAYCARE
...
; Biker
	...
	const EVENT_BEAT_JUGGLER_DWAYNE
	const EVENT_BEAT_ENGINEER_HARRIS
...
; Schoolboy
	...
	const EVENT_BEAT_FLEDGLING_JOHNNY
...
; Pokemaniac
	...
	const EVENT_BEAT_COOLTRAINERM_BEN
...
; Bug Catcher
	...
	const EVENT_BEAT_COOLTRAINERM_ROB
...
; Elite Four and Champion
	...
	const EVENT_BEAT_ELITE_4_GIOVANNI
...
; Johto itemballs
	const EVENT_FLAMBEAR_POKEBALL_IN_OAKS_LAB
	const EVENT_CRUIZE_POKEBALL_IN_OAKS_LAB
	const EVENT_CHIKORITA_POKEBALL_IN_OAKS_LAB
	...
	const EVENT_BRASS_TOWER_1F_PARLYZ_HEAL
	const EVENT_BRASS_TOWER_2F_X_ACCURACY
	...
	const EVENT_BRASS_TOWER_4F_ESCAPE_ROPE
	...
	const EVENT_BOULDER_MINES_1F_GREAT_BALL
	const EVENT_BOULDER_MINES_1F_X_ATTACK
	const EVENT_BOULDER_MINES_1F_POTION
	const EVENT_BOULDER_MINES_B4F_AWAKENING
	const EVENT_BOULDER_MINES_B1F_TM_SWIFT
	const EVENT_BOULDER_MINES_B1F_X_DEFEND
	const EVENT_BOULDER_MINES_B5F_ELIXER
	const EVENT_BOULDER_MINES_B5F_HYPER_POTION
	const EVENT_SLOWPOKE_WELL_B1F_SUPER_POTION
	const EVENT_SLOWPOKE_WELL_B2F_TM_RAIN_DANCE
	const EVENT_ENDON_CAVE_B1F_SMOKE_BALL
	...
	const EVENT_CHARRED_SUMMIT_ETHER
	const EVENT_CHARRED_SUMMIT_REVIVE
	const EVENT_JOULE_CAVE_ESCAPE_ROPE
	const EVENT_JOULE_CAVE_MAX_REVIVE
	const EVENT_JOULE_CAVE_HYPER_POTION
	...
	const EVENT_MAGMA_SHAFT_B2F_CHARCOAL
	...
	const EVENT_AMPARE_CAVERN_REVIVE
	const EVENT_AMPARE_CAVERN_TM_MEGAPHONE
	...
	const EVENT_DRAGONS_MAWS_DRAGON_FANG
	const EVENT_69E
	const EVENT_ROUTE_26_MAX_ELIXER; zap cannon in darkcavevioletentrance
	const EVENT_ROUTE_27_TM_SOLARBEAM
	const EVENT_ROUTE_27_RARE_CANDY
	const EVENT_ROUTE_29_POTION
	const EVENT_ROUTE_29_POTION_2
	const EVENT_ROUTE_31_FULL_HEAL
	...
	const EVENT_BOULDER_MINES_B4F_ULTRA_BALL
	const EVENT_ROUTE_45_NUGGET
	const EVENT_GOT_TM01_DYNAMICPUNCH
	const EVENT_ENDON_CAVE_B1F_ELIXER
	const EVENT_ROUTE_45_MAX_POTION
	const EVENT_ROUTE_46_X_SPEED; route 7 tm roar
; Johto people
	const EVENT_RIVAL_SILENT_TOWN
	const EVENT_RIVAL_OAKS_LAB_ENTRANCE
	const EVENT_BLUE_OAKS_LAB_ENTRANCE
	const EVENT_DAISY_OAKS_LAB_ENTRANCE
	const EVENT_BLUE_SILENT_TOWN
	const EVENT_SILVER_IN_OAKS_LAB
	const EVENT_BLUE_IN_OAKS_LAB
	...
	const EVENT_RIVAL_BURNED_TOWER ;used for the people in slowpoke well b2f, and rockets in guardhouse, and tail salesman
	...
	const EVENT_ALLOY_CAPTAIN_AND_TOWER_SAGES_GONE
	...
	const EVENT_ROUTE_43_GATE_ROCKETS; used for making hidden stairs appear
	...
	const EVENT_TEAM_ROCKET_BASE_B2F_ELECTRODE_1; used to make imposter and executive disappear in boss room
	const EVENT_TEAM_ROCKET_BASE_B2F_ELECTRODE_2
	const EVENT_TEAM_ROCKET_BASE_B2F_ELECTRODE_3
	const EVENT_ROUTE_112_WORKERS_AT_STAND_GATE
	const EVENT_STAND_CITY_ROCKETS_DEPARTED
	const EVENT_DAY_CARE_MAN_IN_DAY_CARE
	const EVENT_DAY_CARE_MAN_ON_ROUTE_106
	const EVENT_DAY_CARE_MON_1
	const EVENT_DAY_CARE_MON_2
	const EVENT_STAND_CITY_ZOO_MONS_GONE
	...
	const EVENT_ILEX_FOREST_LASS; used for making silver and imposter disappear after initial encounter by computer console
	const EVENT_6A0
	const EVENT_6A1
	...
	const EVENT_MAGMA_SHAFT_B1F_BOULDER_1
	const EVENT_MAGMA_SHAFT_B1F_BOULDER_2
	const EVENT_MAGMA_SHAFT_B1F_BOULDER_3
	const EVENT_MAGMA_SHAFT_B1F_BOULDER_4
	const EVENT_6BC
	const EVENT_6BD
	const EVENT_6BE
	const EVENT_6BF
	...
	const EVENT_ROUTE_30_BATTLE; used, this is the password to shut the console down
	...
	const EVENT_FAST_SHIP_CABINS_TALKED_WITH_CAPTAIN_FIRST_TIME
	...
	const EVENT_745
	const EVENT_746
	const EVENT_NATIONAL_PARK_STANDCITY_GATE_OFFICER_CONTEST_DAY
	const EVENT_NATIONAL_PARK_STANDCITY_GATE_OFFICER_NOT_CONTEST_DAY
	const EVENT_GOLDENROD_TRAIN_STATION_GENTLEMAN
	const EVENT_BURNED_TOWER_B1F_BEASTS_1
	const EVENT_BURNED_TOWER_B1F_BEASTS_2
	const EVENT_KOBAN_ISLAND_CLAIR_BLOCKING_DRAGONS_MAW
	const EVENT_CLAIRS_HOUSE_HIDE_CLAIR
	...
	const EVENT_AQUARIUM_ROCKET_TAKEOVER_ACTIVE
	...
	const EVENT_BLUEFOREST_SANTOS_OF_SATURDAY
	...
	const EVENT_WHITNEY_IN_BOULDER_MINES
	const EVENT_BURNED_TOWER_1F_EUSINE ;morty in the gym, actually whitney
	const EVENT_761
	const EVENT_762
...
; Kanto people
	...
	const EVENT_ROUTE_5_6_POKEFAN_M_BLOCKS_UNDERGROUND_PATH ;rockets and boat in route 5/south point docks, and honto town base
	...
	const EVENT_772
	const EVENT_MT_MOON_SQUARE_ROCK ; see below
	const EVENT_MT_MOON_SQUARE_CLEFAIRY ; this is used now - cam :^)
...
; Kanto itemballs
	...
	const EVENT_BOULDER_MINES_B2F_ELIXER
	const EVENT_BOULDER_MINES_B2F_TM_STEEL_WING
	const EVENT_BOULDER_MINES_B3F_IRON ; 780
	const EVENT_BOULDER_MINES_B3F_PP_UP
	const EVENT_BOULDER_MINES_B3F_REVIVE
...
; New to Crystal
	...
	const EVENT_MAGMA_SHAFT_B1F_HYPER_POTION
	const EVENT_MAGMA_SHAFT_B1F_SMOKE_BALL
	const EVENT_PICKED_UP_CHARCOAL_FROM_HO_OH_ITEM_ROOM
	const EVENT_NANJO_FOREST_MAX_REVIVE
	const EVENT_NANJO_FOREST_ULTRA_BALL
	const EVENT_NANJO_FOREST_FULL_HEAL
	const EVENT_NANJO_FOREST_FULL_RESTORE
	...
	const EVENT_BOULDER_MINES_B2F_HEART_STONE ; 7a0
	const EVENT_PICKED_UP_MOON_STONE_FROM_AERODACTYL_ITEM_ROOM
	const EVENT_PICKED_UP_HEAL_POWDER_FROM_AERODACTYL_ITEM_ROOM
	const EVENT_JOULE_CAVE_ZAPDOS_ROOM_HIDDEN_BRIGHTPOWDER
	const EVENT_AZALEA_TOWN_KURT
	const EVENT_ILEX_FOREST_KURT
	const EVENT_JOULE_CAVE_MAX_POTION
	const EVENT_JOULE_CAVE_NUGGET
	const EVENT_TEKNOS_GRAMPA_AT_HOME
	const EVENT_TEKNOS_GRAMPA_LOOKING_FOR_LITTLE_GIRL
	const EVENT_EUSINE_IN_BURNED_TOWER
	const EVENT_LITTLE_GIRL_IN_BOULDER_MINES
	const EVENT_LITTLE_GIRL_AT_HOME
	...
	const EVENT_7C6
	const EVENT_7C7
	const EVENT_JOULE_CAVE_IRON
	const EVENT_JOULE_CAVE_ULTRA_BALL
