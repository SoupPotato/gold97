...
; Johto story events
	...
	const EVENT_GOT_ODD_EGG_FROM_ELMS_AIDE
...
; Kanto hidden items
	...
	const EVENT_FOUND_MACHINE_PART_IN_CERULEAN_GYM; used, for getting dragon orb
...
; Extras for gold 97
	...
	const EVENT_DIGLETTS_CAVE_HIDDEN_MAX_REVIVE_NEW
...
; Johto people
	...
	const EVENT_MAGMA_SHAFT_ENTEI
	const EVENT_TIDAL_GROTTO_SUICUNE
	...
	const EVENT_AMPARE_CAVERN_RAIKOU
