...
; Johto people
	...
	const EVENT_BLACKTHORN_CITY_SUPER_NERD_BLOCKS_GYM; used for workers on route 32/112
	const EVENT_BLACKTHORN_CITY_SUPER_NERD_DOES_NOT_BLOCK_GYM; this is the event for clearing the rocket hideout in stand city, but not the the radio tower
	...
	const EVENT_ILEX_FOREST_FARFETCHD; used, this is what makes zoo pokes disappear in stand city
