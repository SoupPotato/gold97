...
; Johto hidden items
	...
	const EVENT_OLD_CITY_HIDDEN_HYPER_POTION
...
; Extras for gold 97
	...
	const EVENT_THIS_WHOLE_SCRIPT_WAS_A_MISTAKE
...
; More Johto story events
	...
	const EVENT_EXPLODING_TRAP_5; used for trees leading to eastward summit
...
; Johto people
	...
	const EVENT_RIVAL_ELM_ENTRANCE
	const EVENT_BLUE_ELM_ENTRANCE
	const EVENT_DAISY_ELM_ENTRANCE
	const EVENT_BLUE_SILENT_TOWN
	const EVENT_SILVER_IN_ELMS_LAB
